!(function (t) {
    ...
    var e = {
        ...
        stickyHeader: function () {
            if (
                t(".sticky-header").length &&
                (new Waypoint.Sticky({
                    element: t(".sticky-header")[0],
                    stuckClass: "fixed",
                    offset: -10,
                }),
                !t(".header-bottom").find(".logo, .cart-dropdown").length)
            ) {
        ...
        headerSearchToggle: function () {
            t(".search-toggle").on("click", function (e) {
                ...
                t("body").on("click", function (e) {
                    t(".header-search-wrapper").hasClass("show") &&
        ...
        owlCarousels: function () {
            ...
            o.owlCarousel(
                ...
                t(".home-featured-products").owlCarousel(
                    t.extend(!0, {}, e, {
                        loop: !1,
                        margin: 30,
                        autoplay: !1,
                ...
                t(".widget-banners-slider").owlCarousel(
                    t.extend(!0, {}, e, {
                        lazyLoad: !0,
                        navText: [
                ...
                t(".widget-testimonials-slider").owlCarousel(
                    t.extend(!0, {}, e, {
                        lazyLoad: !0,
                        navText: [
                            '<i class="icon-angle-left">',
                ...
                t(".widget-posts-slider").owlCarousel(
                    t.extend(!0, {}, e, {
                        lazyLoad: !0,
                        navText: [
                            '<i class="icon-angle-left">',
                ...
                t(".widget-featured-products").owlCarousel(
                    t.extend(!0, {}, e, {
                        lazyLoad: !0,
                        nav: !0,
                        navText: [
                ...
                t(".related-posts-carousel").owlCarousel(
                    t.extend(!0, {}, e, {
                        loop: !1,
                        margin: 30,
                        navText: [
                ...
                t(".boxed-slider").on("loaded.owl.lazy", function (e) {
                    t(e.element).closest(".boxed-slider").addClass("loaded");
                }),
                t(
                ...
                t("#carousel-custom-dots .owl-dot").click(function () {
                    t(".product-single-carousel").trigger("to.owl.carousel", [
                        t(this).index(),
                        300,
                    ]);
                });
        ...
        lightBox: function () {
            ...
            n.each(function () {
                ...
                t(".prod-full-screen").click(function (e) {
                    var i;
                    (i = e.currentTarget.closest(".product-slider-container")
                ...
                t("a.btn-quickview").on("click", function (o) {
                    o.preventDefault(), e.ajaxLoading();
            ...
            t(".filter-toggle a").click(function (e) {
                ...
                t(".sidebar-overlay").click(function (e) {
                    t(".filter-toggle").removeClass("opened"),
                        t("main").removeClass("sidebar-opened");
                }),
        ...
        loginPopup: function () {
            t(".login-link").click(function (t) {
                $("#login_register_modal").modal("show"), t.preventDefault();
            });
        },
        ...
        productsCartDropDown: function () {
            ...
            let t = 0,
                e = localStorage.getItem("products_cart");
            (t = (e = JSON.parse(e)).length),
                e.forEach((t) => {
                ...
                jQuery(".cart-count").append(t);
        },
        addToCart: function () {
            let e = this;
            t(".add-cart").click(function (t) {
                let o = localStorage.getItem("products_cart");
                o = JSON.parse(o);
                let n = jQuery(this).data("product");
                let person_type_id = jQuery(this).data("person-type-id");
                let clientTypePrices = n.client_type_prices;
                let sale_unit_price = n.sale_unit_price;
                if(person_type_id && clientTypePrices.length > 0){
                    let clientTypePrice = clientTypePrices.find(x => x.person_type_id == person_type_id);
                    if(clientTypePrice){
                        sale_unit_price = clientTypePrice.price;
                    }
                }
                let item_unit_types = n.item_unit_types;
                if(item_unit_types){
                ...
                n.sale_unit_price = sale_unit_price;

                o.find((t) => t.id == n.id)
                    ? e.alreadyProductCart()
                    : (o.push(n),
                      localStorage.setItem("products_cart", JSON.stringify(o)),
                      e.productsCartDropDown(),
                      e.successAddProduct(),
                      e.calculateTotalCart(),
                      $("#product_added").html(
                          `\n\t\t\t\t\t\t<h1 class="product-title">${
                              n.name
                          }</h1>\n\t\t\t\t\t\t<div class="price-box">\n\t\t\t\t\t\t\t<span class="product-price">S/ ${Number(
                              n.sale_unit_price
                          ).toFixed(
                              2
                      ...
                      $("#product_added_image").html(
                          `<img src="/storage/uploads/items/${n.image_medium}" class="img" alt="product">`
                      ));
            });
        },
        ...
        calculateTotalCart: function () {
            let t = localStorage.getItem("products_cart");
            t = JSON.parse(t);
            let e = 0;
            t.forEach((t) => {
                e += parseFloat(t.sale_unit_price);
            }),
                $(".cart-total-price").empty(),
                $(".cart-total-price").append(e.toFixed(2));
        },
    ...
    var o = t(".loadmore .btn");
    jQuery(document).ready(function () {
        e.init();
    }),
        t(window).on("load", function () {
            t("body").addClass("loaded"), e.scrollBtnAppear();
        }),
        t(window).on("scroll", function () {
            e.scrollBtnAppear();
        });

    // Agregar los handlers globales
