    ...
    <div style="
      ">
        ...
        <div class="float-left" style="width: 77%;">
            <table class="full-width">
                <tr>
                    ...
                    <td width="30%" class="text-center align-top">
                        <div class="border-box radius-5 p-1">
            ...
            <div class="mt-2 border-box radius-5">
                <table class="full-width">
                    <tr>
                        <th class="bt text-center">
                            LETRA DE CAMBIO
                        </th>
                        <th class="bl bt text-center">
                            RUC
                        </th>
                        <th class="bl bt text-center">
                            FECHA DE GIRO
            ...
            <div class="" style="margin-top:17px; "></div>
            <div class="full-width mt-2">
                ...
                <span style=" display:inline-block; width: 45%;height:100px;" class="border-box radius-5 p-1">
                    <table class="full-width">
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>TELÉFONO:</strong>
                                @if($endorsement_telephone)
                                {{ $endorsement_telephone }}
                                @else
                                @endif
                            </td>
                        </tr>
                ...
                <span style=" display:inline-block; width: 45%;height:115px;" class="border-box radius-5 p-1">
                    <table class="full-width">
                        <tr>
                            <td colspan="2">
                                <strong>
