                    ...
                    <tbody>
                        @foreach ($records as $key => $value)
                            @php
                                ...
                                $total = null;
                                $quantity = null;
                                $seller_name = isset($value->seller_id)? App\Models\Tenant\User::find($value->seller_id)->name : null;
                                $document_type = App\Models\Tenant\Catalogs\DocumentType::find($value->document_type_id)->description;
