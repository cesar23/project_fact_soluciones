...
<style>
    ...
    th:nth-child(2), td:nth-child(2) { width: 12%; } /* Proveedor */
    th:nth-child(3), td:nth-child(3) { width: 8%; }  /* Teléfono */
    th:nth-child(4), td:nth-child(4) { width: 8%; }  /* Zona */
    th:nth-child(5), td:nth-child(5) { width: 8%; }  /* Comprador */
    th:nth-child(6), td:nth-child(6) { width: 8%; }  /* Tipo */
    ...
    th:nth-child(14), td:nth-child(14) { width: 6%; } /* Pagado */
...
<body>
    <div class="title">Estado de Cuentas por Pagar al {{ date('Y-m-d') }}</div>
    ...
    @if (!empty($records))
        <table>
                    ...
                    <tbody>
                        ...
                        @endphp
                                <tr>
                                    <td class="celda text-center {{ $class }}">{{ $value['supplier_ruc'] ?? '-' }}</td>
                                    <td class="celda text-center {{ $class }}">{{ $value['supplier_name'] ?? '-' }}</td>
                                    <td class="celda text-center {{ $class }}">{{ $value['supplier_telephone'] ?? '-' }}</td>
                                    <td class="celda text-center {{ $class }}">{{ $value['supplier_zone'] ?? '-' }}</td>
