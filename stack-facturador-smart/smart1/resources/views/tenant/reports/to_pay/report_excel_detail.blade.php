                        ...
                        @foreach ($records as $key => $value)
                            ...
                            @if ($total_to_pay > 0)
                                <tr>
                                    ...
                                    <td class="celda">{{ $value['supplier_number'] ?? '-' }}</td>
                                    <td class="celda">{{ $value['supplier_telephone'] ?? '-' }}</td>
                                    <td class="celda">{{ $value['supplier_address'] ?? '-' }}</td>
                                    <td class="celda">{{ $value['user_name'] ?? '-' }}</td>
                                    <td class="celda">{{ $value['delay_payment'] ?? 0 }}</td>
                                    <td class="celda">{{ $value['total'] }}</td>
                                    @if (!empty($value['payments']) && count($value['payments']) > 0)
                                ...
                                @if (!empty($value['payments']) && count($value['payments']) > 1)
