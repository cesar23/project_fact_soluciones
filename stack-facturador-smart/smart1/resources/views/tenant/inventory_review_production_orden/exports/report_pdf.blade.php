...
<body>
    ...
    <div class="text-center">
        <strong>
            <h2>
                REPORTE DE INVENTARIO DETALLADO - PICKING
            </h2>
        </strong>
    </div>
        ...
        <tbody>
            @foreach ($records as $idx => $row)
                ...
                <tr>
                    ...
                    <td align="right">{{ $row['total_quantity'] }}</td>
                    <td align="right">{{ $row['count_production_order'] }}</td>
                    <td align="right">{{ $row['production_orders_number']->implode(', ') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
