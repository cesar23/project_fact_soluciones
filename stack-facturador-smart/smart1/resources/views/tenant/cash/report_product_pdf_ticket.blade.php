    ...
    <table class="" width="100px">
        ...
        <tr>
            ...
            @if ($withIgvProductReportCash)
                <th class="border-top-bottom desc-9 text-center" width="40px" style="padding-top:4px; padding-bottom:4px; ">IGV</th>
            @endif
        ...
        @foreach($documents as $item)
            <tr>
                ...
                @if ($withIgvProductReportCash)
                    <td class="text-right desc-9">{{ App\CoreFacturalo\Helpers\Template\ReportHelper::setNumber($item['total_taxes']) }}</td>
                @endif
            ...
            <tr>
                ...
                @if ($withIgvProductReportCash)
                    <td class="text-center desc align-center font-bold" colspan="2">
                        {{ App\CoreFacturalo\Helpers\Template\ReportHelper::setNumber($total_taxes) }}
                    </td>
                @endif
                <td class="text-center desc align-center font-bold" colspan="2">
