                    ...
                    <tbody>
                        @foreach ($records as $key => $value)
                            ...
                            if ($type === 'purchase') {
                                ...
                                $class_model = get_class($value);
                                if ($class_model === 'App\Models\Tenant\DocumentItem') {
                                    $document = $value->document;
                                    $document_description = $document->document_type->description;
                                } elseif ($class_model === 'App\Models\Tenant\QuotationItem') {
                            ...
                            <tr>
                                ...
                                <td class="celda">{{ $document_description }}</td>
                                ...
                                @php
                                    $value->total =
                                        in_array($document->document_type_id, ['01', '03']) &&
                                        in_array($document->state_type_id, ['09', '11'])
                                            ? 0
                                            : $value->total;
                                @endphp
