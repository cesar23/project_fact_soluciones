...
class CompanyResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        if (!$gekawa_url || !$gekawa_1 || !$gekawa_2) {
            if ($system_config) {
                $gekawa1 = $system_config->gekawa1;
                $gekawa2 = $system_config->gekawa2;
                $gekawaurl = $system_config->gekawaurl;
                if ($gekawa1 && $gekawa2 && $gekawaurl) {
                    $gekawa_url = $gekawaurl;
                    $gekawa_1 = $gekawa1;
                    $gekawa_2 = $gekawa2;
                }
            }
        ...
        return [
            // 'gekawa_url' => $gekawa_url,
            // 'gekawa_1' => $gekawa_1,
            // 'gekawa_2' => $gekawa_2,
            'type_send_pse' => $this->type_send_pse,
