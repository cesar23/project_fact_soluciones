...
class Functions
{
    ...
    public static function validateUniqueDocument($soap_type_id, $document_type_id, $series, $number, $model, $company_id = null)
    {
        ...
        if ($configuration->multi_companies && $company_id) {
            ...
            if ($document) {
                $date_of_issue = null;
                //si  $document->date_of_issue no es un string se convierte a string
                ...
                throw new DuplicateDocumentException(
                    "El documento: {$document_type_id} {$series}-{$number} ya se encuentra registrado.",
                    0,
                    [
                ...
                // throw new Exception("El documento: {$document_type_id} {$series}-{$number} ya se encuentra registrado.",2003);
            }
        }
    }
