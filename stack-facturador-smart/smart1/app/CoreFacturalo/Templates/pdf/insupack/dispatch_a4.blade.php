        ...
        <tr>
            <td width="45%" class="border-box pl-3">
                <table class="full-width">
                    ...
                    <tr>
                        @isset($document->driver->identity_document_type_id)
            ...
            <td width="50%" class="border-box pl-3">
                ...
                @if ($document->transport_mode_type_id === '01')
                    @isset($document->dispatcher->identity_document_type_id)
                        @php
                        ...
                        <table class="full-width">
                            <tr>
                                <td style="text-decoration: underline;" colspan="2"><strong>EMPRESA DE
                ...
                @else
                    <table class="full-width">
                        ...
                        @if ($document->transport_data)
                            <tr>
                                <td><strong>Número de placa del vehículo:
                                        {{ $document->transport_data['plate_number'] }}</strong> </td>
                            </tr>
                        @endif
                        ...
                        @if ($document->secondary_license_plates)
                            @if ($document->secondary_license_plates->semitrailer)
                                <tr>
                                    <td><strong>Número de placa semirremolque:
                                            {{ $document->secondary_license_plates->semitrailer }}</strong> </td>
                                </tr>
                            @endif
                        @endif
