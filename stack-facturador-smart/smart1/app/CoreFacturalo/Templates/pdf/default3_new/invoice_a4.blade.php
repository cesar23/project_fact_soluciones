@php
    ...
    foreach ($document->items as $it) {
        $quantity_items++;
        $description = '';
        if ($it->name_product_pdf) {
            $description = $it->name_product_pdf;
        } else {
        ...
        if(strlen($description) <= 50){
            ...
            $quantity_items+=9;
        }else if(strlen($description) <= 450){
            $quantity_items+=10;
        }else if(strlen($description) <= 500){
            $quantity_items+=11;
        }else if(strlen($description) <= 550){
            $quantity_items+=12;
        }else if(strlen($description) <= 600){
            $quantity_items+=13;
        }else if(strlen($description) <= 650){
            $quantity_items+=14;
        }
    ...
    <table class="full-width mt-0 mb-0">
        <thead>
            <tr class="">
                ...
                <!-- <th class="border-top-bottom text-right py-1 desc" class="cell-solid" width="12%">Lote</th>
