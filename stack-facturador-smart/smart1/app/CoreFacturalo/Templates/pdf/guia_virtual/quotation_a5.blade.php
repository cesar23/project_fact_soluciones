...
<div style="float:left;width:30%;">
    <div style="border-radius:10px;border:1px solid black;text-align:center;width: 100%;height: 70px;">
        ...
        <div class="text-center" style="margin-top:3px;">{{ get_document_name('quotation', 'Cotización') }}</div>
...
<table class="full-width mt-4">
    ...
    <tr>
        ...
        @if($document->date_of_due)
            <td class="text-left desc" width="15%">Tiempo de Validez:</td>
            <td class="text-left desc" width="10%">{{ $document->date_of_due }}</td>
        @endif
    </tr>
    @if ($customer->address !== '')
    <tr>
        <td class="text-left desc" class="align-top">Dirección:</td>
        ...
        @if($document->delivery_date)
            <td class="text-left desc" width="15%">Tiempo de Entrega:</td>
            <td class="text-left desc" width="10%">{{ $document->delivery_date }}</td>
        @endif
    </tr>
    @endif
    ...
    <tr>
        <td class="text-left desc" class="align-top">T. Pago:</td>
        <td class="text-left desc" colspan="">
            {{ $document->payment_method_type->description }}
        </td>
        @if($document->sale_opportunity)
            <td class="text-left desc" width="15%">O. Venta:</td>
            <td class="text-left desc" width="10%">{{ $document->sale_opportunity->number_full }}</td>
        @endif
    </tr>
    @endif
    ...
    <tr>
        <td class="text-left desc" class="align-top">N° Cuenta:</td>
    ...
    <tr>
        <td class="text-left desc" class="align-top">Dir. Envío:</td>
        <td class="text-left desc" colspan="3">
    ...
    <tr>
        <td class="text-left desc" class="align-top">Teléfono:</td>
        <td class="text-left desc" colspan="3">
            {{ $customer->telephone }}
        </td>
    </tr>
    ...
    <tr>
        <td class="text-left desc" class="align-top">Vendedor:</td>
        <td class="text-left desc" colspan="3">
    ...
    @if ($document->contact)
    <tr>
        <td class="text-left desc" class="align-top">Contacto:</td>
        <td class="text-left desc" colspan="3">
            {{ $document->contact }}
        </td>
    </tr>
    ...
    @if ($document->phone)
    <tr>
        <td class="text-left desc" class="align-top">Telf. Contacto:</td>
        <td class="text-left desc" colspan="3">
            {{ $document->phone }}
        </td>
    </tr>
...
<table class="full-width mt-3">
    @if ($document->description)
        <tr>
            <td class="text-left desc" width="15%" class="align-top">Observación: </td>
            <td class="text-left desc" width="85%">{!! str_replace("\n", "<br/>", $document->description) !!}</td>
...
{{-- <table class="full-width mt-3">
    @if ($document->purchase_order)
        <tr>
            <td class="text-left desc" width="15%">Orden de compra: </td>
            <td>:</td>
            <td class="text-left desc" class="text-left">{{ $document->purchase_order }}</td>
        </tr>
    @endif
</table> --}}
...
<br>
<table class="full-width " style="margin: 0; padding: 0; border-spacing: 0; border-collapse: collapse;">
    <tbody>
        <tr>
            <td class="text-left desc" style="padding: 0; margin: 0;">
                <strong>Pagos:</strong>
            </td>
        </tr>
        @php
