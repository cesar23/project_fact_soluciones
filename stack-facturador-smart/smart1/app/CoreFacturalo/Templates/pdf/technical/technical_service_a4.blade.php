...
<table  class="full-width mt-2">
    <tr>
        ...
        <td> <input {{ $document->ironing_and_painting ? 'checked="checked"' : '' }}  class="tech-chk" type="checkbox"> Planchado y pintura </td>
        <td> <input {{ $document->equipments ? 'checked="checked"' : '' }}  class="tech-chk" type="checkbox"> Equipos </td>
        <td> <input {{ $document->preventive_maintenance ? 'checked="checked"' : '' }}  class="tech-chk" type="checkbox"> Mantenimiento preventivo </td>
        <td> <input {{ $document->corrective_maintenance ? 'checked="checked"' : '' }}  class="tech-chk" type="checkbox"> Mantenimiento correctivo </td>
    </tr>
</table>
