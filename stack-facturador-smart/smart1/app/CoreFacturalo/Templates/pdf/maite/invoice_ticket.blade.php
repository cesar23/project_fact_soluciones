...
<table class="full-width">
    ...
    <tr>
        <td class="text-center desc pt-5">Para consultar el comprobante ingresar a <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a></td>
    </tr>
</table>
