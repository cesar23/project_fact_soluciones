...
<div  style="position: fixed; top:150px;">
    ...
    <div class="text-center desc-9">
        ...
        <p class="desc-9">Representación impresa de <br> <span class="font-bold">{{ $document->document_type->description }}</span> <br> Consulte su comprobante de pago en: <br> <span class="font-bold">{!! searchUrl() !!} </span></p>
