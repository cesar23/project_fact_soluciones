...
<body class="ticket">
    ...
    <table class="full-width">
        ...
        <tr>
            ...
            @endphp
            <td class="text-center desc pt-5">Representación impresa de la {{--$description--}} {!! $description !!} Esta puede ser
                consultada en <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a></td>
        </tr>
    </table>
