...
<table class="full-width">
   ...
   {{-- <tr>
    ...
    <tr>
        <td class="text-center desc pt-2">Representación Impresa del <strong>COMPROBANTE ELECTRÓNICO</strong>, ha sido emitido desde <strong>www.econtfact.com. </strong> Sistema del Contribuyente, para visualizarlo visita: <strong> {!! searchUrl() !!}</strong></td>
    </tr>
</table>
