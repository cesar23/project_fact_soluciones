...
<body>
        ...
        <tbody>
            ...
            <tr>
                ...
                @if ($document->purchase_order)
                    <td class="pl-3">
                        <strong>Orden de compra: </strong>{{ $document->purchase_order }}
                    </td>
                @endif
                @if ($document->order_form_external)
                    <td class="pl-3">
                        <strong>Orden de pedido: </strong>{{ $document->order_form_external }}
                    </td>
                @endif
            </tr>
            <tr>
                @if ($document->related_document)
                    <td class="pl-3">
                        <strong>Documento relacionado: </strong>{{ $document->related_document }}
                    </td>
                @endif
                @if ($document->transfer_reason_description)
                    <td class="pl-3">
                        <strong>Descripción de motivo de traslado:
                        </strong>{{ $document->transfer_reason_description }}
                    </td>
                @endif
    ...
    <table class="full-width border-box mt-10 mb-10">
        <tr>
            <td width="45%" class="border-box pl-3" valign="top">
                <table class="full-width">
                    <tr>
                        <td style="text-decoration: underline;" colspan="2" valign="top"><strong>UNIDAD DE TRANSPORTE - CONDUCTOR
                        </td>
                    </tr>
    ...
    <td width="50%" class="border-box pl-3">
        <table class="full-width">
            ...
            @if ($document->transport_mode_type_id === '01' && isset($document->dispatcher->name))
                @php
