...
<body>
                ...
                <td class="text-left desc" width="20%">
                    <div class="company_logo_box">
                        <img src="data:{{ mime_content_type(public_path("{$logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("{$logo}"))) }}"
                            alt="{{ $company->name }}" class="company_logo" style="max-width: 600px;">
                    </div>
                </td>
            @else
                <td class="text-left desc" width="20%">
    ...
    <table class="full-width mt-10 mb-10">
        <thead class="">
            <tr class="bg-grey">
                <th class="border-top-bottom desc text-center py-2" width="6%">Item</th>
                <th class="border-top-bottom desc text-center py-2">Descripción</th>
                <th class="border-top-bottom desc text-center py-2" width="6%">Unid.</th>
                <th class="border-top-bottom desc text-center py-2" width="6%">Cant.</th>
                @if (!$configurations->document_columns)
                    <th class="border-top-bottom desc text-center py-2" width="0%"></th>
                    <th class="border-top-bottom desc text-center py-2" width="0%"></th>
                    <th class="border-top-bottom desc text-center py-2" width="0%"></th>
                    <th class="border-top-bottom desc text-right desc py-2" width="10%">P.Unitario</th>
                    <th class="border-top-bottom desc text-right desc py-2" width="6%">Desct.</th>
                    <th class="border-top-bottom desc text-right desc py-2" width="12%">Importe</th>
                @else
                    @foreach ($documment_columns as $column)
                        <th class="border-top-bottom desc text-center py-2" style="text-align: {{ $column->column_align }};"
width="{{ $column->width }}%">
                            {{ $column->name }}</th>
                    @endforeach
                @endif
