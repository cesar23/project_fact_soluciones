...
?>
@for($items_in_array = 0; $items_in_array < $total_array_chunk; $items_in_array++) @php $array_to_work=$array_chunk[$items_in_array] ?? null @endphp <html>
    ...
    <body>
        ...
        <div class="company_logo_box" style="position: absolute; text-align: center; top:30%;">
            <img src="data:{{mime_content_type(public_path("status_images".DIRECTORY_SEPARATOR."anulado.png")) }};base64, {{base64_encode(file_get_contents(public_path("status_images".DIRECTORY_SEPARATOR."anulado.png"))) }}" alt="anulado" class="" style="opacity: 0.6; {{ $border_st }}">
        </div>
        @endif
        ...
        @endif
        <table border="0" height="100px" width="100%">
            <tr>
                <td align="center" valign=middle height="84" width="25%">
                    <img @if($company_logo!=null) src="data:{{mime_content_type(public_path("{$company_logo}")) }};base64,{{base64_encode(file_get_contents(public_path("{$logo"))) }}" @endif alt="{{ $company_name }}" class="company_logo" style="max-height: 50px; max-width: 200px;">

                </td>
                <td height="84" width="50%" align="center" valign=top>
                ...
                <td align="left" valign=middle height="84" width="25%">
        ...
        <table border="0" width="100%">
            <tr>
                <td colspan=5 height="14" align="right" valign=middle bgcolor="#CCCCCC">SEÑORES:
                </td>
                <td style="border-top: 1px solid #b2b2b2; border-bottom: 1px solid #b2b2b2; border-left: 1px solid #b2b2b2; border-right: 1px solid #b2b2b2" colspan=23 align="left" valign=middle>{{ $customer_name }}</td>
                <td colspan=6 align="center" valign=middle bgcolor="#CCCCCC">F. DE EMISIÓN
                </td>
            </tr>
            <tr>
                <td colspan=5 rowspan=2 height="28" align="right" valign=top bgcolor="#CCCCCC">Dirección:
                </td>
                <td style="border-top: 1px solid #b2b2b2; border-bottom: 1px solid #b2b2b2; border-left: 1px solid #b2b2b2; border-right: 1px solid #b2b2b2" colspan=23 rowspan=2 align="left" valign=top>{{ $customer_address }}</td>
                <td style="border-top: 1px solid #b2b2b2; border-bottom: 1px solid #b2b2b2; border-left: 1px solid #b2b2b2; border-right: 1px solid #b2b2b2" colspan=6 align="center" valign=middle>{{ $date }}</td>
            </tr>
            <tr>
                <td colspan=6 align="center" valign=middle bgcolor="#CCCCCC">F. DE VENCIMIENTO
                </td>
            </tr>
            <tr>
                <td colspan=5 height="14" align="right" valign=middle bgcolor="#CCCCCC">TELÉFONO
                </td>
                <td style="border-top: 1px solid #b2b2b2; border-bottom: 1px solid #b2b2b2; border-left: 1px solid #b2b2b2; border-right: 1px solid #b2b2b2" colspan=10 align="left" valign=middle>{{ $customer_phone}}</td>
                <td colspan=3 align="center" valign=middle bgcolor="#CCCCCC">RUC
                </td>
                <td style="border-top: 1px solid #b2b2b2; border-bottom: 1px solid #b2b2b2; border-left: 1px solid #b2b2b2; border-right: 1px solid #b2b2b2" colspan=10 align="left" valign=middle>
                    {{ $customer_dni }}
                </td>
                <td style="border-top: 1px solid #b2b2b2; border-bottom: 1px solid #b2b2b2; border-left: 1px solid #b2b2b2; border-right: 1px solid #b2b2b2" colspan=6 align="center" valign=middle>{{$due_date }}</td>
            </tr>
            <tr>
                <td height="14" colspan="34">
                    &nbsp;
        ...
        <table border="0" width="100%">
            ...
            <!-- CABECERA ItemS -->
            <tr>
                <td style="{!! $borderTop !!}" height="14" width="8%" align="center" valign=middle bgcolor="#CCCCCC">Cant
                </td>
                <td style="{!! $borderTop !!}" width="8%" align="center" valign=middle bgcolor="#CCCCCC">U. de Medida
                </td>
                <td style="{!! $borderTop !!}" align="center" valign=middle bgcolor="#CCCCCC">Item
                </td>
                <td style="{!! $borderTop !!}" width="15%" align="center" valign=middle bgcolor="#CCCCCC">Valor unitario
                </td>
                <td style="{!! $borderTop !!}" width="8%" align="center" valign=middle bgcolor="#CCCCCC">Descuento
                </td>
                <td style="{!! $borderTop !!}" width="15%" align="center" valign=middle bgcolor="#CCCCCC">Total
                </td>
            </tr>
            <!-- CABECERA ItemS -->
            <!-- ItemS -->
            <!-- ItemS -->
            @for($i = 0; $i < $cantidad_linea; $i++) <?php
                                                        $border = '';
                                                        if ($i == 0) {
                                                        ...
                                                        ?> <tr>
                <td style="{{ $border_common }}" height="14" width="8%" align="center" valign=middle>{{ $item['qty'] }}</td>
                <td style="{{ $border_common }}" align="left" width="8%" valign=middle>{{ $item['unit'] }}</td>
                <td style="{{ $border_common }}" align="left" width="46%" valign=middle>@if($item_blank_line==true)
                    {!! $item['description'] !!}
                    @else
                    {{ $item['description'] }}
                    @endif
                </td>
                <td style="{{ $border_common }}" align="right" width="15%" valign=right>{{ $item['p_unit'] }}</td>
                <td style="{{ $border_common }}" align="right" width="8%" valign=middle>{{ $item['dscto'] }}</td>
                <td style="{{ $border_common }}" align="right" width="15%" valign=middle>{{ $item['total'] }} </td>
                </tr>
                @endfor
                <!-- Tabla de items -->
                <!-- ItemS -->
                <!-- ItemS -->
                <tr>
                    <td height="15" colspan="6" width="100%" align="left" style="border-top: 1px solid #b2b2b2;" valign=middle>{!! $total_word !!}</td>
                </tr>
                <!-- LETRAS -->
        </table>
        <table border="0" width="100%">
            ...
            <tr>
                <td height="14" rowspan=3 colspan="34"><br>
                </td>
            </tr>
        </table>
        <table border="0" width="100%">
            <!-- QR -->
            <tr>
                <td height="110" width="20%" align="center" valign=middle>
        ...
        <table border="0" width="100%">
            <tr>
                <td height="112" width="70%" align="left" valign=top>
                    {{ $extra_info }}
                    <br>
                </td>
                <td width="30%" align="right">
                    <table width="100%" border="0">
                        <tr>
                            <td align="right" width="50%" valign=middle>Importe de venta
                            </td>
                            <td align="right" width="50%" valign=middle>{{ $total_importe }}</td>
                        </tr>
                        <tr>
                            <td align="right" width="50%" valign=middle>Op. gravada
                            </td>
                            <td align="right" width="50%" valign=middle>{{ $total_gravado }}</td>
                        </tr>
                        <tr>
                            <td align="right" width="50%" valign=middle>Op. inafecta
                            </td>
                            <td align="right" width="50%" valign=middle>{{ $total_inefacta }}</td>
                        </tr>
                        <tr>
                            <td align="right" width="50%" valign=middle>Op. exonerada
                            </td>
                            <td align="right" width="50%" valign=middle>{{ $total_exonerada }}</td>
                        </tr>
                        <tr>
                            <td align="right" width="50%" valign=middle>IGV (18.00%)
                            </td>
                            <td align="right" width="50%" valign=middle>{{ $total_igv }}</td>
                        </tr>
                        <tr>
                            <td align="right" width="50%" bgcolor="#CCCCCC" valign=middle>Total
                            </td>
                            <td align="right" width="50%" bgcolor="#CCCCCC" valign=middle>{{ $total_importe }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table border="0" width="100%">
            <colgroup span="34"></colgroup>
            <tr>
                <td colspan=34 rowspan=2 height="14" align="right" valign=middle><br>
                </td>
            </tr>
        </table>
        <table border="0" width="100%">
            <colgroup span="34"></colgroup>
            <tr>
                <td colspan=34 rowspan=2 align="right" valign=middle> {{$items_in_array +1 }}/{{$total_array_chunk}}
                </td>
            </tr>
        </table>
        @endfor
