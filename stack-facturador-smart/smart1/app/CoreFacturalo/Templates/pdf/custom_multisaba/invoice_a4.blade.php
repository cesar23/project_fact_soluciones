...
<table class="full-width mt-0 mb-0" >
    <thead >
        <tr class="">
            ...
            <th class="border-top-bottom text-center py-1 desc" class="cell-solid"  width="10%">V.UNIT</th>
            <th class="border-top-bottom text-right py-1 desc" class="cell-solid"  width="10%">P.UNIT</th>
    ...
    <tbody class="">
        ...
        <tr>
            <td class="p-1 text-center align-top desc cell-solid" colspan="3" rowspan="6">
                <img src="data:image/png;base64, {{ $document->qr }}" class="p-0 m-0" style="width: 100px;" />
                {{-- @php
            ...
            <td class="p-1 text-center align-center desc cell-solid " rowspan="6">

                <table class="full-width border-box">
                    <tr class="border-box">
                        <td class="font-bold">Banco</td>
                        <td class="font-bold">Moneda</td>
                        <td class="font-bold">Código de Cuenta</td>
                    </tr>
            @if(in_array($document->document_type->id,['01','03']))
                @foreach($accounts as $account)
                    <tr>
                        <td>{{$account->bank->description}}</td>
                        <td>{{$account->currency_type->description}}</td>
                        <td>{{$account->cci}}</td>
                    </tr>
                @endforeach
            @endif
            ...
            <td class="p-1 text-right align-center desc cell-solid font-bold" colspan="2">
                OP. INAFECTAS {{$document->currency_type->symbol}}
            </td>
            <td class="p-1 text-right align-center desc cell-solid font-bold">{{ number_format($document->total_unaffected, 2) }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="p-1 text-right align-center desc cell-solid font-bold">{{ number_format($document->total_igv, 2) }}</td>
        </tr>
        <tr>
            <td class="p-1 text-right align-center desc cell-solid font-bold" colspan="2">
                TOTAL A PAGAR. {{$document->currency_type->symbol}}
            </td>
            <td class="p-1 text-right align-center desc cell-solid font-bold">{{ number_format($document->total, 2) }}</td>
        </tr>
    </tbody>
