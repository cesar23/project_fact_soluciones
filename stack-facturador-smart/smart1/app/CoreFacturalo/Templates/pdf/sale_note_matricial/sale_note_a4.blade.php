...
<table class="full-width">
    <tr>
        ...
        <td width="20%"></td>
        <td width="30%" class=" py-4 px-2 text-center">
...
<table class="full-width mt-10 mb-10">
    <thead class="">
    <tr class="bg-grey">
        <th class="border-top-bottom border-left text-center py-2" width="8%">Cant.</th>
    ...
    @foreach($document->items as $row)
        ...
        <tr>
            <td colspan="6" class="border-right border-left border-bottom"></td>
        </tr>
    @endforeach
