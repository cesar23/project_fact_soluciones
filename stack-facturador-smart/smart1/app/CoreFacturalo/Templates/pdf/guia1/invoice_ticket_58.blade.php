...
<table class="full-width" style="font-family: helvetica">
    ...
    @foreach(array_reverse((array) $document->legends) as $row)
        ...
        @else
            ...
            @endif
            <tr>
                <td class="text-center desc-9 pt-2">Representación impresa del Comprobante de Pago Electrónico. <br/>Esta puede ser consultada en <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a></td>
            </tr>
</table>
