            ...
            <td width="70%" class="pl-2 pr-4 border-box2"
                ...
                <table class="full-width py-4s px-s2 ext-center">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;" class=" font-xs" colspan="4">{{ $customer->number }}</td>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;" class=" font-xs" colspan="4">
                            {{ $customer->name }}
                    ...
                    @if ($customer->address !== '')
                        <tr>
                            ...
                            <td class=" font-xs" style="text-transform: uppercase;" colspan="4">
                                {{ $customer->address }}
                    ...
                    @if ($document->detraction && $invoice->operation_type_id == '1004')
                        <tr>
                            <td colspan="6"><strong>Detalle - Servicios de transporte de carga</strong></td>
                        </tr>
                        <tr>
            ...
            <td width="30%" class="border-box1 py-4 px-2 ext-center">
                ...
                <table class="full-width ">
                    ...
                    <tr>
                        ...
                        <td class=" font-xs" colspan="3">{{ $document->date_of_issue->format('Y-m-d') }}</td>
                    ...
                    @if ($invoice)
                        <tr>
                            ...
                            <td class=" font-xs" colspan="4">{{ $invoice->date_of_due->format('Y-m-d') }}</td>
                        </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td class="font-bold font-xs" width="8px">:</td>
                        <td class=" font-xs" colspan="4">{{ $document->time_of_issue }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="font-bold font-xs" width="8px">:</td>
                        <td class=" font-xs" colspan="4">{{ $document->currency_type->description }}</td>
                    </tr>
                    ...
                    @if ($document->reference_data)
                        <tr>
                            ...
                            <td width="8px" class="font-bold">:</td>
                            <td colspan="4">{{ $document->reference_data }}</td>
                        </tr>
                    @endif
                    ...
                    @if ($document->detraction)
                        @if ($document->detraction->pay_constancy)
                            <tr>
                                ...
                                <td width="120px" class="font-bold">Constancia de pago</td>
                                <td width="8px" class="font-bold">:</td>
                                <td colspan="3">{{ $document->detraction->pay_constancy }}</td>
                            </tr>
                        @endif
                    @endif
...
@endif --}}
        <div class="border-box-radius">
            ...
            {{-- <span class="text-center">Representación impresa del Comprobante de Pago Electrónico. <br/>Esta puede ser consultada en {!! searchUrl() !!}</span> --}}
        </div>
    </div>
    ...
    <div class="font-xs text-center" style="margin-top:10px;">
        <center>
            ...
            <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a>
