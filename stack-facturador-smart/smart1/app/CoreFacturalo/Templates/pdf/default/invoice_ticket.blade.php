@php
    ...
    if ($document_base) {
        $document_affected = $document_base->affected_document ?? $document_base->affected_sale_note;
        $affected_document_number = $document_affected
            ? $document_affected->series . '-' . str_pad($document_affected->number, 8, '0', STR_PAD_LEFT)
    ...
    <table class="full-width">
        ...
        @if ($configuration->info_customer_pdf)
            ...
            @isset($customer->search_telephone)
                ...
                @endif
            @endisset
            @if ($customer->address !== '' || $address_supply)
                <tr>
                    <td class="align-top">
        ...
        @if ($document->related_document && isset($document->related_document->first()->related_document))
            <tr>
                <td class="desc" class="align-top">
                    <p class="desc">Documento relacionado:</p>
                </td>
                <td class="desc" style="text-transform: uppercase;">
        ...
        @if ($document->detraction)
            ...
            @if ($invoice->operation_type_id == '1004')
                ...
                @if (isset($document->detraction->origin_location_id[2]) && !$detraction_transport_not_require_fields)
                    <tr>
                        <td class="align-top">
                ...
                @endif
                @if (isset($document->detraction->origin_address) && !$detraction_transport_not_require_fields)
                    <tr>
                        <td class="align-top">
                ...
                @endif
                @if (isset($document->detraction->delivery_location_id[2]) && !$detraction_transport_not_require_fields)
                    <tr>
                        <td class="align-top">
                ...
                @endif
                @if (isset($document->detraction->delivery_address) && !$detraction_transport_not_require_fields)
                    <tr>
                ...
                @endif
                @if (isset($document->detraction->reference_value_service))
                    <tr>
                        <td class="align-top">
                ...
                @endif
                @if (isset($document->detraction->reference_value_effective_load) && !$detraction_transport_not_require_fields)
                    <tr>
                ...
                @endif
                @if (isset($document->detraction->reference_value_payload) && !$detraction_transport_not_require_fields)
                    <tr>
                        <td class="align-top">
                ...
                @endif
                @if (isset($document->detraction->trip_detail) && !$detraction_transport_not_require_fields)
                    <tr>
                        <td class="align-top">
            ...
            <thead class="">
                <tr class="">
                    ...
                    @if (!$configuration->document_columns)
                        ...
                        <th class="border-bottom border-left desc text-right desc py-2 px-2" width="10%">Dct</th>
                                ...
                                <td class="text-left desc" class="text-right desc desc align-top border-left px-2"
                                    ...
                                    @if ($column->value == 'image')
                                        <img src="data:{{ mime_content_type(public_path(parse_url($value, PHP_URL_PATH))) }};base64, {{ base64_encode(file_get_contents(public_path(parse_url($value, PHP_URL_PATH)))) }}"
                                            alt="Imagen" style="width: 80px; height: auto;">
            ...
            <tr>
                <td class="text-center desc pt-5">
                    ...
                    <br /> <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}"
                        style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a>
        ...
        <tr>
            ...
            <td class="text-center desc pt-2">Representación impresa de la {{-- $description --}}
                ...
                consultada en <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}"
                    style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a></td>
        </tr>
    </table>
                        ...
                        <tr>
                            <td class="text-center desc">
                                <img src="{{ $imageSrc }}" alt="Voucher de Pago"
                                    style="max-width: 350px; max-height: 350px; margin: 10px auto; display: block; border: 1px solid #ddd; padding: 5px;">
                            </td>
                        </tr>
                    </table>
                </div>
