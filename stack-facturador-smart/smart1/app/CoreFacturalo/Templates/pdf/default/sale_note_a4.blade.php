@php
    ...
    if($supply_document){
        ...
        $mz = $supply->mz;
        $lte = $supply->lte;
        $address_supply = $sector->name . ' - ' . $supply_via->name . ' ' . ($mz ? 'Mz ' . $mz : '') . ($lte ? ' Lte ' . $lte : '');
    ...
    <div class="header">
        ...
        <div style="float:left;width:48%;text-align:left;">
            ...
            @if ($configuration->show_company_address)
                @isset($establishment->district_id)
            ...
            <h6 style="margin: 0px !important;line-height:0px;">
                @isset($establishment->telephone)
                    {{ $establishment->telephone !== '-' ? '' . $establishment->telephone : '' }}
                @endisset
            </h6>
            @if ($configuration->show_email)
                <h6 style="margin: 0px !important;line-height:0px;">
                    @isset($establishment->email)
        ...
        @else
            ...
            @if ($document->additional_information)
                <tr>
                    ...
                    <td colspan="3">{{ $document->additional_information }}</td>
                </tr>
            @endif
        @endif
                    ...
                    <tr>
                        ...
                        <td class="text-left desc" class="text-left desc align-top border-left px-2"
                            ...
                            <span style="font-size: 12px;margin-top: 0px;padding-top: 0px;">
                                ...
                                @if($is_integrate_system && isset($row->item->presentation) &&
                            ...
                            @if (
                                $configuration->presentation_pdf &&
                                    ...
                                    isset($row->item->presentation->description) && !$is_integrate_system)
                                <div>
