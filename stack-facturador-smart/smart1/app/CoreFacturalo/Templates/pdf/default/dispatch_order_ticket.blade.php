                                    @php
                                        ...
                                        $tittle =
                                            $document->prefix . '-' . str_pad($document->number, 8, '0', STR_PAD_LEFT);
                                        $payments = $document->sale_note->payments;
                                        ...
                                        if ($is_integrate_system) {
                                            $sale_note = \App\Models\Tenant\SaleNote::where(
                                                'id',
                                                $document->sale_note_id,
                                            )->first();
                                    ...
                                    <body>
                                        ...
                                        <table class="full-width">
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="desc">N° bultos:</p>
                                                </td>
                                                <td>
                                                    <p class="desc">{{ number_format($document->package_number, 0) }}</p>
                                                </td>
                                            </tr>
                                        ...
                                        <table class="full-width">
                                            ...
                                            @if ($quotation)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="desc">
                                                            {{ $quotation->prefix }}-{{ $quotation->number }}</p>
                                                    </td>
                                                </tr>
                                            @endif
                                            @if ($sale_note)
