...
<body>
    ...
    <table class="full-width border-box mt-10 mb-10">
        ...
        <tbody>
            ...
            <tr>@php
                $colspan = $is_itinerant ? 2 : 1;
            @endphp
                <td colspan="{{ $colspan }}">
                    P.Partida:{{ $document->origin ? func_get_location($document->origin->location_id) : null }} -
                    {{ $document->origin->address }}</td>
                @if (!$is_itinerant)
                    <td>P.Llegada:
    ...
    <table class="full-width border-box mt-10 mb-10">
        ...
        <tbody>
            ...
            @else
                <tr>
                    @if (isset($document->transport_data))
                ...
                <tr>
                    @if (isset($document->secondary_license_plates))
                        @if (isset($document->secondary_license_plates->semitrailer))
