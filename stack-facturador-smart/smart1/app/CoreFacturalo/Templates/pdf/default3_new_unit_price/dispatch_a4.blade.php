...
<body>
    ...
    <table class="full-width border-box mt-10 mb-10">
        <tr>
            <td width="45%" class="border-box pl-3" valign="top">
                <table class="full-width">
                    <tr>
                        <td style="text-decoration: underline;" colspan="2" valign="top"><strong>UNIDAD DE
                                TRANSPORTE - CONDUCTOR</td>
                    </tr>
    ...
    <td width="50%" class="border-box pl-3">
        <table class="full-width">
            ...
            @if ($document->transport_mode_type_id === '01' && isset($document->dispatcher))
                @php
