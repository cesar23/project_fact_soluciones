...
<body class="ticket">
    ...
    <table class="full-width">
        ...
        <tr>
            <td colspan="2" class="text-center desc pt-2">Representación impresa del Comprobante de Pago Electrónico. <br/>Esta puede ser consultada en <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a></td>
        </tr>
    </table>
    <table class="full-width">
