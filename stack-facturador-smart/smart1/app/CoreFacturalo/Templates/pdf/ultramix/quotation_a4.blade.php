...
<div class="full-width" style="padding-top: 3px; padding-left: 0px">
    <div style="width:50%; float: left; ">
        ...
        @endif
        <div class="font-lg text-center" style="padding-top: 37px; padding-left: 0px">{{ $company->number }}</div>
    </div>
    <div style="width:45%; float: right; ">
        <div style="padding-top: 0px; ">
            <h5 class="text-center font-xxlg font-bold" style="color: #ffffff; margin-bottom: 0px!important">COTIZACIÓN</h5>
...
<table class="full-width mt-10">
    ...
    <tr class="bg-red text-white">
        <th class="bg-red text-white text-center py-2 mt-5 mb-5" style="padding-top: 10px; padding-bottom: 10px;" width="15%">CANTIDAD  <br>(m3)</th>
        <th class="bg-red text-white text-center py-2">DESCRIPCIÓN</th>
        <th class="bg-red text-white text-center py-2 mt-5 mb-5" style="padding-top: 10px; padding-bottom: 10px;" width="15%">PRECIO <br> (m3)</th>
        <th class="bg-red text-white text-center py-2 mt-5 mb-5" style="padding-top: 10px; padding-bottom: 10px;" width="15%">TOTAL <br> (S/)</th>
    </tr>
    </thead>
    <tbody>
    ...
    <table class="full-width border-box2 my-2 ">
        <thead>
                <tr class="bg-grey2">
                    ...
                    <th class="p-1 border-grey font-xs font-bold font-xs" style="padding-top: 5px; padding-bottom: 5px;">NUMERO DE CUENTA CORRIENTE <br> ULTRA MIX PERU SAC</th>
        ...
        <tfoot>
            ...
            <td class="bg-red text-white text-center py-2 mt-5 mb-5 font-bold" style="padding-top: 10px; padding-bottom: 10px;" width="15%">SUB TOTAL {{ $document->currency_type->symbol }}</td>
            <td class="bg-grey2 border-grey text-black text-right py-2 mt-5 mb-5 font-bold" style="padding-top: 10px; padding-bottom: 10px; padding-right: 5px;" width="15%">{{ number_format($document->total_taxed, 2) }}</td>
        </tr>

        <tr class="">
            <td class="bg-red text-white text-center py-2 mt-5 mb-5 font-bold" style="padding-top: 10px; padding-bottom: 10px;" width="15%">IGV 18% {{ $document->currency_type->symbol }}</td>
            <td class="bg-grey2 border-grey text-black text-right py-2 mt-5 mb-5 font-bold" style="padding-top: 10px; padding-bottom: 10px; padding-right: 5px;" width="15%">{{ number_format($document->total_igv, 2) }}</td>
        </tr>
        <tr class="">
            <td class="bg-red text-white text-center py-2 mt-5 mb-5 font-bold" style="padding-top: 10px; padding-bottom: 10px;" width="15%">TOTAL {{ $document->currency_type->symbol }}</td>
            <td class="bg-grey2 border-grey text-black text-right py-2 mt-5 mb-5 font-bold" style="padding-top: 10px; padding-bottom: 10px; padding-right: 5px;" width="15%">{{ number_format($document->total, 2) }}</td>
        </tr>
    </tbody>
</table>
<br>
