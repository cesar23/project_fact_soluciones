...
$cycle_items = 15 - $document->items()->count();
@endphp
<html>
...
<body>
    ...
    <table class="full-width">
        <tr>
            <td width="60%" class="text-center pr-2">
                ...
                <h6>{{ ($establishment->telephone !== '-')? 'Telf. '.$establishment->telephone : '' }} - {{ ($establishment->email !== '-')? 'Email: '.$establishment->email : '' }} - {{ ($establishment->web_address !== '-')? 'Web: '.$establishment->web_address : '' }}</h6>
    ...
    <table class="full-width mt-0 mb-0 has-items">
        <thead>
            <tr class="">
                <th class="text-center py-1 desc" width="12%">CÓDIGO</th>
                <th class="text-center py-1 desc" width="40%">DESCRIPCIÓN</th>
                <th class="text-center py-1 desc" width="8%">CANT.</th>
                <th class="text-center py-1 desc" width="8%">U.M.</th>
                <th class="text-right py-1 desc" width="12%">P.U</th>
                <th class="text-center py-1 desc" width="8%">DESC</th>
                <th class="text-center py-1 desc" width="12%">IMPORTE</th>
            </tr>
        </thead>
        <tbody class="">
            ...
            <tr>
                ...
                <td class="p-1 text-left align-top desc"></td>
                <td class="p-1 text-center align-top desc"></td>
                <td class="p-1 text-center align-top desc"></td>
                <td class="p-1 text-right align-top desc"></td>
                <td class="p-1 text-right align-top desc"></td>
                <td class="p-1 text-right align-top desc"></td>
            </tr>
            @endfor
