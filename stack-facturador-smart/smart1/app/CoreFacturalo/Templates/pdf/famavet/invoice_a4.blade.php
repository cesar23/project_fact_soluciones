    ...
    <table class="full-width mt-10 mb-10" >
        ...
        @foreach($document->items as $row)
            ...
            <tr>
                ...
                <td class="desc border-left-right text-center align-top">{{ number_format($row->unit_price, $decimal_quantity) }}</td>
                <td class="desc border-left-right text-center align-top">{{ number_format($row->unit_value, $decimal_quantity) }}</td>
                <td class="desc border-left-right text-center align-top">
                    @if($row->discounts)
                        @php
    ...
    <div class="div-table no_pad_mar">
         <div class="div-table-row no_pad_mar">
            ...
            <div class="div-table-col w-100 text-center mt-2 mb-2">
                Representación impresa del Comprobante de Pago Electrónico. Esta puede ser consultada en: {!! searchUrl() !!}
            </div>
