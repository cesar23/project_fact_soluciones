            ...
            @php
                    ...
                    if ($firstDiscount) {
                        ...
                        if ($discount_type_id == '02') {
                            $total_subtotal = number_format($firstDiscount->base * 1.18, 2);
                        }
                    }
                @endphp
            <tr>
    ...
    <table class="full-width">
        ...
        <tr>
            <td class="text-center desc ">Para consultar el comprobante ingresar
                a <a href="{!! route('search.index', ['external_id' => $document->external_id]) !!}" style="text-decoration: none; font-weight: bold;color:black;">{!! searchUrl() !!}</a></td>
        </tr>
    </table>
