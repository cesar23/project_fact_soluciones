                ...
                <tr>
                    ...
                    <td style="font-size:11px;"  class="text-center align-top">
                        ...
                        @else
                            ...
                            {{ number_format(($row->total + ($row->total_discount * 1.18 )) / $row->quantity, 2) }}
                        @endif
                    </td>

                    <td style="font-size:11px;" class="text-right align-top">{{ number_format($row->total_discount * 1.18, 2) }}</td>
                    
                    <td style="font-size:11px;" class="text-right align-top">{{ number_format($row->unit_price * $row->quantity, 2) }}</td>
                </tr>
                <tr>
            ...
            @if ($document->total_discount > 0)
                <tr>
                    <td colspan="6" class="text-right font-bold desc">Descuento total:
                        {{ $document->currency_type->symbol }}</td>
                    <td class="text-right font-bold desc">{{ number_format($document->total_discount * 1.18, 2) }}</td>
                </tr>
            @endif
