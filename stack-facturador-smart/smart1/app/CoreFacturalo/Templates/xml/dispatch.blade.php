...
<DespatchAdvice xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <cac:Shipment>
        ...
        <cbc:GrossWeightMeasure
            unitCode="{{ $document['unit_type_id'] }}">{{ number_format($document['total_weight'], 3, '.', '') }}</cbc:GrossWeightMeasure>
        ...
        <cac:Delivery>
            ...
            <cac:DeliveryAddress>
                ...
                @endif
                <cac:AddressLine>
                    <cbc:Line>@if($document['transfer_reason_type_id'] != '18')<![CDATA[{{ $document['delivery_address'] }}]]>@endif</cbc:Line>
                </cac:AddressLine>
            </cac:DeliveryAddress>
            <cac:Despatch>
                ...
                <cac:DespatchAddress>
                    ...
                    @if($document['transfer_reason_type_id'] != '02' && $document['transfer_reason_type_id'] != '07')
                        @if($document['customer_identity_document_type_id'] === '6')
