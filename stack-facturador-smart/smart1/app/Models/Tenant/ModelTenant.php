...
class ModelTenant extends Model
{
    ...
    public function scopeFilterPurchaseOrden($query, $purchaseOrden, $exceptId = null)
    {
        return $query->whereRaw('UPPER(TRIM(purchase_orden)) = ?', [strtoupper(trim($purchaseOrden))])
