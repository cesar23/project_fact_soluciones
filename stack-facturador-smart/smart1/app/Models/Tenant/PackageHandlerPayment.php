...
class PackageHandlerPayment extends ModelTenant
{
    ...
    {
        return $this->belongsTo(PackageHandler::class, 'package_handler_id');
    }
    ...
    public static function sumPaymentsBySaleNote($sale_notes_id)
    {
        ...
        foreach (array_chunk($sale_notes_id, $chunkSize) as $chunk) {
            $total += self::whereIn('sale_note_id', $chunk)->sum('payment');
        }
