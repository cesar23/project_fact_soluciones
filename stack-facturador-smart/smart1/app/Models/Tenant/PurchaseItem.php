...
class PurchaseItem extends ModelTenant
{
    ...
    protected $fillable = [
        ...
        'item_lot_group_id',
        'name_product_pdf',
        'unit_value_apportioned_affected',
        'unit_price_apportioned_affected',
        'stock_before_apportionment',
        'unit_price_apportioned',
        'total_apportioned',
        'discount_apportioned',
        'affected',
        'observation_apportionment',
        'quantity_apportionment',
    ];
    ...
    {
        return $this->purchase->exchange_rate_sale;
    }
