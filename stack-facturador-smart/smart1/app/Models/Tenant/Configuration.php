...
class Configuration extends ModelTenant
{
    ...
    protected $fillable = [
        ...
        'production_2',
        'visa_charge_percentage',
        'visa_charge',
        'send_auto_email',
        'profit_margin',
        'update_items_prices_with_exchange_rate_sale',
        'open_cash_with_exchange_rate_sale',
        'restore_num_order_purchase',
        'list_individual_products_by_warehouse_compound',
        'taxed_igv_visible_doc',
        'taxed_igv_visible_cot',
        'show_pos_lite_v2',
        'purchase_apportionment',
        'show_filters_set_items_for_users',
        'paper_size_modal_documents',
        'full_suscription_list_type',
        'show_restrict_stock_in_items_form',
        'nc_payment_nv',
        'generate_multiple_documents_sale_note',
        'glosa_term',
        'export_detail_unpaid',
        'item_set_warehouse_price',
        'pos_quick_sale',
        'show_first_ticket_document',
        'show_currency_in_cash',
        'print_dispatch_ticket_pdf',
        'search_by_model_and_description',
        'show_weigth_dispatches',
        'cash_by_establishment',
        'automatic_cash_beginning_balance',
        'order_purchase_logo',
        'save_unit_type_price_cpe_lite',
        'delete_sale_notes',
        'limit_unit_price_sale',
        'show_notes_reception',
        'detraction_transport_not_require_fields',
        'item_unit_type_by_warehouse',
        'with_igv_product_report_cash',
        'hotel_reservation_type_2',
        'search_packs_document_sale_note',
        'show_web_platform_document_sale_note',
        'purchase_orden_in_item_set',
        'items_delivery_states',
        'show_platform_description',
        'report_box_egress',
        'add_item_barcode_read',
        'show_set_color',
        'label_item_color',
        'add_quantity_in_read_barcode',
        'update_unit_price_sale_in_purchase',
        'hide_quotations_payment',
        'cash_report_with_banks',
        'change_establishment_admin',
        'default_purchase_price_change_item',
        'default_price_change_item',
        'bill_of_exchange_special',
        'plate_number_config',
        'limit_sale_daily_item',
        'taxo_show_purchase_price',
        'date_documents_filter',
        'show_pos_lite',
        'show_export_system',
        'order_concrete',
        'show_categories',
        'show_models',
        'show_brands',
        'bill_of_exchange_template',
        'show_internal_id_list',
        'type_discount',
        'list_unit_type_pos',
        'list_payments_pos',
        'range_item_unit_type',
        'footer_margin',
        'add_margin_bottom',
        'whatsapp_document_message',
        'transport_format',
        'check_reference',
        'search_items_writing',
        'default_document_type_cot',
        'quotation_payment_default',

        'modify_stock_item_direct',
        'credit_default_quotation',
        'item_lots_group_filter_by_warehouse',
        'pos_mode_pharmacy',
        'seller_establishments_all',
        'price_item_007',
        'edit_customer_info_direct',
        'trade_name_pdf',
        'seller_can_ajust_inventory',
        'kit_pdf',
        'pos_direct',
        'search_advance_items',
        'img_lots_in_dispatches',
        'img_lots_in_documents',
        'item_complements',
        ...
        'establishment_address_dispatch_carrier',
        'massive_update',
        'stock_decimal',
        'validate_automatic',
        'allow_seller_change',
        'require_key_for_cancellation',
        'no_payments_less_than_total',
        'show_channels_documents',
        'send_gs1_xml',
        'alert_to_pay',
        'show_zone_instead_subject',
    ];

    protected $casts = [
        'print_vouchers' => 'boolean',
        'anulate_auto' => 'boolean',
        'show_summaries_in_documents' => 'boolean',
        'sales_today' => 'boolean',
        'audit_sales' => 'boolean',
        'igv_discount_base' => 'boolean',
        'quick_access' => 'boolean',
        'show_item_attributes' => 'boolean',
        'production_2' => 'boolean',
        'visa_charge' => 'boolean',
        'send_auto_email' => 'boolean',
        'update_items_prices_with_exchange_rate_sale' => 'boolean',
        'open_cash_with_exchange_rate_sale' => 'boolean',
        'split_quotation_to_document_services_and_not_services' => 'boolean',
        'list_individual_products_by_warehouse_compound' => 'boolean',
        'restore_num_order_purchase' => 'boolean',
        'taxed_igv_visible_doc' => 'boolean',
        'taxed_igv_visible_cot' => 'boolean',
        'show_pos_lite_v2' => 'boolean',
        'purchase_apportionment' => 'boolean',    
        'show_filters_set_items_for_users' => 'boolean',
        'full_suscription_list_type' => 'boolean',
        'show_restrict_stock_in_items_form' => 'boolean',
        'nc_payment_nv' => 'boolean',
        'generate_multiple_documents_sale_note' => 'boolean',
        'export_detail_unpaid' => 'boolean',
        'item_set_warehouse_price' => 'boolean',
        'pos_quick_sale' => 'boolean',
        'show_first_ticket_document' => 'boolean',
        'show_currency_in_cash' => 'boolean',
        'print_dispatch_ticket_pdf' => 'boolean',
        'search_by_model_and_description' => 'boolean',
        'show_weigth_dispatches' => 'boolean',
        'cash_by_establishment' => 'boolean',
        'automatic_cash_beginning_balance' => 'boolean',
        'validate_automatic' => 'boolean',
        'allow_seller_change' => 'boolean',
        'require_key_for_cancellation' => 'boolean',
        'no_payments_less_than_total' => 'boolean',
        'show_channels_documents' => 'boolean',
        'send_gs1_xml' => 'boolean',
        'alert_to_pay' => 'boolean',
        'save_unit_type_price_cpe_lite' => 'boolean',
        'delete_sale_notes' => 'boolean',
        'limit_unit_price_sale' => 'boolean',
        'show_notes_reception' => 'boolean',
        'detraction_transport_not_require_fields' => 'boolean',
        'item_unit_type_by_warehouse' => 'boolean',
        'with_igv_product_report_cash' => 'boolean',
        'hotel_reservation_type_2' => 'boolean',
        'search_packs_document_sale_note' => 'boolean',
        'show_web_platform_document_sale_note' => 'boolean',
        'purchase_orden_in_item_set' => 'boolean',
        'items_delivery_states' => 'boolean',
        'show_platform_description' => 'boolean',
        'report_box_egress' => 'boolean',
        'add_item_barcode_read' => 'boolean',
        'show_set_color' => 'boolean',
        'label_item_color' => 'boolean',
        'add_quantity_in_read_barcode' => 'boolean',
        'update_unit_price_sale_in_purchase' => 'boolean',
        'hide_quotations_payment' => 'boolean',
        'cash_report_with_banks' => 'boolean',
        'change_establishment_admin' => 'boolean',
        'default_purchase_price_change_item' => 'boolean',
        'default_price_change_item' => 'boolean',
        'bill_of_exchange_special' => 'boolean',
        'plate_number_config' => 'boolean',
        'limit_sale_daily_item' => 'boolean',
        'taxo_show_purchase_price' => 'boolean',
        'date_documents_filter' => 'boolean',
        'show_pos_lite' => 'boolean',
        'show_export_system' => 'boolean',
        'order_concrete' => 'boolean',
        'show_categories' => 'boolean',
        'show_models' => 'boolean',
        'show_brands' => 'boolean',
        'show_internal_id_list' => 'boolean',
        'type_discount' => 'boolean',
        'list_unit_type_pos' => 'boolean',
        'list_payments_pos' => 'boolean',
        'range_item_unit_type' => 'boolean',
        'transport_format' => 'boolean',
        'check_reference' => 'boolean',
        'search_items_writing' => 'boolean',
        'default_document_type_cot' => 'boolean',
        'quotation_payment_default' => 'boolean',
        'modify_stock_item_direct' => 'boolean',
        'credit_default_quotation' => 'boolean',
        'item_lots_group_filter_by_warehouse' => 'boolean',
        'pos_mode_pharmacy' => 'boolean',
        'seller_establishments_all' => 'boolean',
        'price_item_007' => 'boolean',
        'edit_customer_info_direct' => 'boolean',
        'trade_name_pdf' => 'boolean',
        'seller_can_ajust_inventory' => 'boolean',
        'kit_pdf' => 'boolean',
        'pos_direct' => 'boolean',
        'search_advance_items' => 'boolean',
        'img_lots_in_dispatches' => 'boolean',
        'img_lots_in_documents' => 'boolean',
        ...
        'establishment_address_dispatch_carrier' => 'bool',
        'massive_update' => 'boolean',
        'show_zone_instead_subject' => 'boolean',
    ];
    ...
    public function getCollectionData()
    {
        ...
        // $establishment = DB::connection('tenant')->table('establishments')->where('id', $establishment_id)->first();
        ...
        $skins = Skin::all();
        if (!$company->gekawa_url || !$company->gekawa_1 || !$company->gekawa_2) {
            $system_config = SystemConfiguration::first();
            if ($system_config->gekawaurl && $system_config->gekawa1 && $system_config->gekawa2) {
                $company->gekawa_url = $system_config->gekawaurl;
                $company->gekawa_1 = $system_config->gekawa1;
                $company->gekawa_2 = $system_config->gekawa2;
            }
        }
        $type = "seller";
        if ($user) {
        ...
        $app_configuration_taxo_data = DB::connection('tenant')
            ->table('app_configuration_taxo_role')
            ->join('app_configuration_taxo', 'app_configuration_taxo_role.app_configuration_taxo_id', '=', 'app_configuration_taxo.id')
            ->select(
                'app_configuration_taxo_role.id',
                'app_configuration_taxo_role.is_visible as role_is_visible',
                'app_configuration_taxo.menu',
                'app_configuration_taxo.route',
                'app_configuration_taxo.is_visible as taxo_is_visible'
            )
            ->where('app_configuration_taxo_role.role_id', $type)
            ->get();
        $app_configuration_taxo_role = $app_configuration_taxo_data->transform(function ($item) {
            // $app_configuration_taxo_role = AppConfigurationTaxoRole::where('role_id', $type)->get()->transform(function ($item) {
            // $app_configuration_taxo = $item->appConfigurationTaxo;
            $is_visible = false;
            if ($item->taxo_is_visible) {
                $is_visible = $item->role_is_visible == 1;
            }
            return [
                'id' => $item->id,
                'name' => $item->menu,
        ...
        if (!isset($establishment->country)) {
            $establishment->country = [
                'description' => 'PERÚ',
            ];
        }
        return [
            'print_vouchers' => (bool) $this->print_vouchers,
            'anulate_auto' => (bool) $this->anulate_auto,
            'show_summaries_in_documents' => (bool) $this->show_summaries_in_documents,
            'sales_today' => (bool) $this->sales_today,
            'audit_sales' => (bool) $this->audit_sales,
            'igv_discount_base' => (bool) $this->igv_discount_base,
            'quick_access' => (bool) $this->quick_access,
            'show_item_attributes' => (bool) $this->show_item_attributes,
            'production_2' => (bool) $this->production_2,
            'visa_charge_percentage' => $this->visa_charge_percentage,
            'visa_charge' => (bool) $this->visa_charge,
            'send_auto_email' => (bool) $this->send_auto_email,
            'profit_margin' => (float) $this->profit_margin,
            'update_items_prices_with_exchange_rate_sale' => (bool) $this->update_items_prices_with_exchange_rate_sale,
            'open_cash_with_exchange_rate_sale' => (bool) $this->open_cash_with_exchange_rate_sale,
            'allow_seller_change' => (bool) $this->allow_seller_change,
            'require_key_for_cancellation' => (bool) $this->require_key_for_cancellation,
            'no_payments_less_than_total' => (bool) $this->no_payments_less_than_total,
            'show_channels_documents' => (bool) $this->show_channels_documents,
            'send_gs1_xml' => (bool) $this->send_gs1_xml,
            'alert_to_pay' => (bool) $this->alert_to_pay,
            'split_quotation_to_document_services_and_not_services' => (bool) $this->split_quotation_to_document_services_and_not_services,
            'restore_num_order_purchase' => (bool) $this->restore_num_order_purchase,
            'list_individual_products_by_warehouse_compound' => (bool) $this->list_individual_products_by_warehouse_compound,
            'taxed_igv_visible_doc' => (bool) $this->taxed_igv_visible_doc,
            'taxed_igv_visible_cot' => (bool) $this->taxed_igv_visible_cot,
            'show_pos_lite_v2' => (bool) $this->show_pos_lite_v2,
            'purchase_apportionment' => (bool) $this->purchase_apportionment,
            'show_filters_set_items_for_users' => (bool) $this->show_filters_set_items_for_users,
            'paper_size_modal_documents' => $this->paper_size_modal_documents,
            'full_suscription_list_type' => (bool) $this->full_suscription_list_type,
            'show_restrict_stock_in_items_form' => (bool) $this->show_restrict_stock_in_items_form,
            'nc_payment_nv' => (bool) $this->nc_payment_nv,
            'generate_multiple_documents_sale_note' => (bool) $this->generate_multiple_documents_sale_note,
            'glosa_term' => $this->glosa_term,
            'export_detail_unpaid' => (bool) $this->export_detail_unpaid,
            'item_set_warehouse_price' => (bool) $this->item_set_warehouse_price,
            'pos_quick_sale' => (bool) $this->pos_quick_sale,
            'show_first_ticket_document' => (bool) $this->show_first_ticket_document,
            'show_currency_in_cash' => (bool) $this->show_currency_in_cash,
            'print_dispatch_ticket_pdf' => (bool) $this->print_dispatch_ticket_pdf,
            'search_by_model_and_description' => (bool) $this->search_by_model_and_description,
            'show_weigth_dispatches' => (bool) $this->show_weigth_dispatches,
            'cash_by_establishment' => (bool) $this->cash_by_establishment,
            'automatic_cash_beginning_balance' => (bool) $this->automatic_cash_beginning_balance,
            'order_purchase_logo' => $this->order_purchase_logo,
            'app_configuration_taxo' => $app_configuration_taxo_role,
            'validate_automatic' => (bool) $this->validate_automatic,
            'save_unit_type_price_cpe_lite' => (bool) $this->save_unit_type_price_cpe_lite,
            'delete_sale_notes' => (bool) $this->delete_sale_notes,
            'limit_unit_price_sale' => (bool) $this->limit_unit_price_sale,
            'show_notes_reception' => (bool) $this->show_notes_reception,
            'detraction_transport_not_require_fields' => (bool) $this->detraction_transport_not_require_fields,
            'item_unit_type_by_warehouse' => (bool) $this->item_unit_type_by_warehouse,
            'with_igv_product_report_cash' => (bool) $this->with_igv_product_report_cash,
            'hotel_reservation_type_2' => (bool) $this->hotel_reservation_type_2,
            'search_packs_document_sale_note' => (bool) $this->search_packs_document_sale_note,
            'show_web_platform_document_sale_note' => (bool) $this->show_web_platform_document_sale_note,
            'purchase_orden_in_item_set' => (bool) $this->purchase_orden_in_item_set,
            'items_delivery_states' => (bool) $this->items_delivery_states,
            'show_platform_description' => (bool) $this->show_platform_description,
            'report_box_egress' => (bool) $this->report_box_egress,
            'add_item_barcode_read' => (bool) $this->add_item_barcode_read,
            'show_set_color' => (bool) $this->show_set_color,
            'label_item_color' => (bool) $this->label_item_color,
            'add_quantity_in_read_barcode' => (bool) $this->add_quantity_in_read_barcode,
            'update_unit_price_sale_in_purchase' => (bool) $this->update_unit_price_sale_in_purchase,
            'hide_quotations_payment' => (bool) $this->hide_quotations_payment,
            'cash_report_with_banks' => (bool) $this->cash_report_with_banks,
            'change_establishment_admin' => (bool) $this->change_establishment_admin,
            'default_purchase_price_change_item' => (bool) $this->default_purchase_price_change_item,
            'default_price_change_item' => (bool) $this->default_price_change_item,
            'bill_of_exchange_special' => (bool) $this->bill_of_exchange_special,
            'limit_sale_daily_item' => (bool) $this->limit_sale_daily_item,
            'plate_number_config' => (bool) $this->plate_number_config,
            'taxo_show_purchase_price' => (bool) $this->taxo_show_purchase_price,
            'date_documents_filter' => (bool) $this->date_documents_filter,
            'show_pos_lite' => (bool) $this->show_pos_lite,
            'show_export_system' => (bool) $this->show_export_system,
            'order_concrete' => (bool) $this->order_concrete,
            'show_categories' => (bool) $this->show_categories,
            'show_models' => (bool) $this->show_models,
            'show_brands' => (bool) $this->show_brands,
            'bill_of_exchange_template' => $this->bill_of_exchange_template,
            'show_internal_id_list' => (bool) $this->show_internal_id_list,
            'type_discount' => (bool) $this->type_discount,
            'list_unit_type_pos' => (bool) $this->list_unit_type_pos,
            'list_payments_pos' => (bool) $this->list_payments_pos,
            'range_item_unit_type' => (bool) $this->range_item_unit_type,
            'add_margin_bottom' => $this->add_margin_bottom,
            'footer_margin' => $this->footer_margin,
            'whatsapp_document_message' => $this->whatsapp_document_message,
            'transport_format' => (bool) $this->transport_format,
            'stock_decimal' => $this->stock_decimal,
            'check_reference' => (bool) $this->check_reference,
            'search_items_writing' => (bool) $this->search_items_writing,

            'default_document_type_cot' => (bool) $this->default_document_type_cot,
            'quotation_payment_default' => (bool) $this->quotation_payment_default,
            'modify_stock_item_direct' => (bool) $this->modify_stock_item_direct,
            'credit_default_quotation' => (bool) $this->credit_default_quotation,
            'item_lots_group_filter_by_warehouse' => (bool) $this->item_lots_group_filter_by_warehouse,
            'pos_mode_pharmacy' => (bool) $this->pos_mode_pharmacy,
            'terms_condition_dispatches' => $this->terms_condition_dispatches,
            'seller_establishments_all' => (bool) $this->seller_establishments_all,
            'price_item_007' => (bool) $this->price_item_007,
            'edit_customer_info_direct' => (bool) $this->edit_customer_info_direct,
            'trade_name_pdf' => (bool) $this->trade_name_pdf,
            'seller_can_ajust_inventory' => (bool) $this->seller_can_ajust_inventory,
            'kit_pdf' => (bool) $this->kit_pdf,
            'pos_direct' => (bool) $this->pos_direct,
            'search_advance_items' => (bool) $this->search_advance_items,
            'img_lots_in_documents' => (bool) $this->img_lots_in_documents,
            'img_lots_in_dispatches' => (bool) $this->img_lots_in_dispatches,
            ...
            'purchase_affectation_igv_type_id' => $this->purchase_affectation_igv_type_id ?? "10",
            ...
            'establishment_address_dispatch_carrier' => (bool)$this->establishment_address_dispatch_carrier,
            'massive_update' => (bool)$this->massive_update,
            'show_zone_instead_subject' => (bool) $this->show_zone_instead_subject,
        ];
    }
    ...
    {
        try {
            $cache_key = CacheTrait::getCacheKey('configuration');
            $config = CacheTrait::getCache($cache_key);
            if (!$config) {
                $config = self::first();
                CacheTrait::storeCache($cache_key, $config);
            }
            return $config;
        } catch (\Exception $e) {
            return self::first();
    ...
    public function getMainWarehouseId()
    {
        if ($this->main_warehouse) {
            ...
            if ($warehouse) {
                return DB::connection('tenant')->table('establishments')->where('id', $warehouse->establishment_id)->first()->id;
            }
        }

        return DB::connection('tenant')->table('establishments')->first()->id;
    }
    ...
    {
        $cache_key = CacheTrait::getCacheKey('public_config');
        $config = CacheTrait::getCache($cache_key);
        if (!$config) {
            $config = self::first();
            CacheTrait::storeCache($cache_key, $config);
        }
        $data = $config->getCollectionData();
