...
use Modules\Suscription\Http\Resources\SuscriptionPaymentCollection;
...
use Modules\Suscription\Models\Tenant\SuscriptionPlan;
    ...
    class PaymentReceiptSuscriptionController extends Controller
    {
        ...
        public function records(Request $request)
        {
            ...
            $value = $request->value;
            $records = SuscriptionPayment::query()
                ->select('client_id', 'child_id', 'document_id', 'sale_note_id')
                ->selectRaw('MAX(id) as id, MAX(period) as period')
                ...
                ->groupBy('client_id', 'child_id', 'document_id', 'sale_note_id');
            

            return new SuscriptionPaymentCollection($records->paginate(config('tenant.items_per_page')));
        }
