    ...
    @foreach ($sections as $section)
        ...
        @foreach ($section['questions'] as $key => $array_question)
            ...
            <table style="border-collapse: collapse;  width: 100%;">
                <thead>
                    <tr>
                        <th style="background-color:rgb(175, 175, 175); text-align:center; border: 1px solid black; padding: 5px;"
                            colspan="3">
                    ...
                    <tr>
                        @for ($i = 0; $i < 3; $i++)
                            @if (isset($array_question[$first_key + $i]['answers']))
                                <th
                                    style="background-color:rgb(175, 175, 175); text-align:center; border: 1px solid rgb(0, 0, 0); padding: 5px;">
                                    RESPUESTA</th>
                                <th
                                    style="background-color:rgb(175, 175, 175); text-align:center; border: 1px solid black; padding: 5px;">
                                    CANTIDAD</th>
                                <th
                                    style="background-color:rgb(175, 175, 175); text-align:center; border: 1px solid black; padding: 5px;">
                                    PORCENTAJE</th>
                    ...
                    @for ($i = 0; $i < $max; $i++)
                        <tr>
                            @for ($j = 0; $j < 3; $j++)
                                ...
                                @else
                                    <td width="33%" style="text-align:center; border: 1px solid black; padding: 5px;"
                                        colspan="3">
                                    </td>
                                @endif
                            @endfor
