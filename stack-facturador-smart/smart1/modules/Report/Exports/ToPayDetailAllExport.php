...
class ToPayDetailAllExport implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles, WithEvents
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Estado de Cuentas por Pagar al ' . date('Y-m-d'));
                ...
                $sheet->getColumnDimension('B')->setWidth(25); // Proveedor
                $sheet->getColumnDimension('C')->setWidth(12); // Teléfono
                $sheet->getColumnDimension('D')->setWidth(15); // Zona
                $sheet->getColumnDimension('E')->setWidth(20); // Vendedor
                ...
                $sheet->getColumnDimension('N')->setWidth(12); // Pagado
