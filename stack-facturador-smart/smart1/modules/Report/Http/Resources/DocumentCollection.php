...
class DocumentCollection extends ResourceCollection
{
    ...
    public function toArray($request)
    {
        ...
        return $this->collection->transform(function (\App\Models\Tenant\Document $row, $key) use ($request) {
            ...
            $payments = $to_export ? $row->payments->toArray(): [];
            return [
                ...
                'items' => $row->items->transform(function ($row, $key) {
                    return [
                        ...
                        'seller' => $row->sellers ? $row->sellers->seller->name : '',
                    ];
                }),
