                        ...
                        <td class="celda">{{$user}}</td>
                                    ...
                                    @if($signal == '07')
                                        ...
                                        @if(in_array($value->state_type_id,['09','11']))
                                            ...
                                            <td class="celda">0</td>
                                        @else
                                            <td class="celda">{{$signal == '07' ? "-" : ""  }}{{ number_format($total_taxed, 2)}}</td>
                                            <td class="celda">{{$signal == '07' ? "-" : ""  }}{{ number_format($total_igv, 2)}}</td>
                                            <td class="celda">{{$signal == '07' ? "-" : ""  }}{{ number_format($total, 2)}}</td>
                                        @endif

                                    @else
                                        <td class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : number_format($total_taxed, 2)}}</td>
                                        <td class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : number_format($total_igv, 2)}}</td>
                                        <td class="celda">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : number_format($total, 2)}}</td>
