                    ...
                    <tbody>
                        @foreach ($records as $key => $value)
                            ...
                            <tr>
                                ...
                                <td class="celda">
                                    {{ isset($value->invoice) ? $value->invoice->date_of_due->format('Y-m-d') : '' }}</td>
                                ...
                                <td class="celda">
                                    @if ($value->quotations_optional_value != null)
                                ...
                                @if ($signal == '07')
                                    @if (in_array($value->state_type_id, ['09', '11']))
                                        ...
                                        <td class="celda">0</td>
                                    @else
                                        <td class="celda text-end">{{ $signal == '07' ? '-' : '' }}{{ $total_taxed }}
                                        </td>
                                        <td class="celda text-end">{{ $signal == '07' ? '-' : '' }}{{ $total_igv }}
                                        </td>
                                        <td class="celda text-end">{{ $signal == '07' ? '-' : '' }}{{ $total }}</td>
                                    @endif
                                @else
