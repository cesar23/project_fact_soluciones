            ...
            <div class="">
                <div class=" ">
                    @php
                        ...
                        $acum_total_usd=0;
                    @endphp
                <table class="" style="font-size:8px;border:none;">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th class="">
                    ...
                    $document_type = $value->getDocumentType();
                                ...
                                if ($value->currency_type_id !== 'PEN' && $apply_conversion_to_pen) {
                        ...
                        <td class="celda">{{$user}}</td>
                                    ...
                                    @if($signal == '07')
                                        ...
                                        @if(in_array($value->state_type_id,['09','11']))
                                            <td class="celda text-end">0</td>
                                            <td class="celda text-end">0</td>
                                            <td class="celda text-end">0</td>
                                        @else
                                            <td class="celda text-end">{{$signal == '07' ? "-" : ""  }}{{ number_format($total_taxed, 2)}}</td>
                                            <td class="celda text-end">{{$signal == '07' ? "-" : ""  }}{{ number_format($total_igv, 2)}}</td>
                                            <td class="celda text-end">{{$signal == '07' ? "-" : ""  }}{{ number_format($total, 2)}}</td>
                                        @endif

                                    @else
                                        <td class="celda text-end">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : number_format($total_taxed, 2)}}</td>
                                        <td class="celda text-end">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : number_format($total_igv, 2)}}</td>
                                        <td class="celda text-end">{{ (in_array($document_type->id,['01','03']) && in_array($value->state_type_id,['09','11'])) ? 0 : number_format($total, 2)}}</td>
                                    ...
                                    @php
                                        $total_taxed = (in_array($document_type->id,['01','03', '07']) && in_array($value->state_type_id,['09','11'])) ? 0 : $total_taxed;
                                        $total_igv = (in_array($document_type->id,['01','03', '07']) && in_array($value->state_type_id,['09','11'])) ? 0 : $total_igv;
                                        $total = (in_array($document_type->id,['01','03', '07']) && in_array($value->state_type_id,['09','11'])) ? 0 : $total;
                                    @endphp
                                </tr>
                                @php
                            ...
                            <tr>
                                ...
                                <td class="celda text-end">{{number_format($acum_total_taxed, 2)}}</td>
                                <td class="celda text-end">{{number_format($acum_total_igv, 2)}}</td>
                                <td class="celda text-end">{{number_format($acum_total, 2)}}</td>
                            </tr>
                            @if(!$apply_conversion_to_pen)
                            <tr>
                                <td class="celda" colspan="16"></td>
                                <td class="celda" >Totales USD</td>
                                <td class="celda text-end">{{number_format($acum_total_taxed_usd, 2)}}</td>
                                <td class="celda text-end">{{number_format($acum_total_igv_usd, 2)}}</td>
                                <td class="celda text-end">{{number_format($acum_total_usd, 2)}}</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
