...
<body>
    <div>
        <h3 align="center" class="title"><strong>REPORTE POR PROOVEDOR</strong></h3>
    </div>
    <br>
        ...
        <table>
            @if (!$records->isEmpty())
                <tr>
                    ...
                    <td align="center">
                        <p><strong>{{ $records[0]->supplier->number }} - {{ $records[0]->supplier->name }}</strong></p>
                    </td>
                </tr>
            @endif
            <tr>
                            ...
                            <tr>
                                ...
                                <td class="celda">
                                    @if ($type == 'purchase_order')
                                        ORDEN DE COMPRA
                                    @else
                                        {{ $value->document_type->description }}
                                    @endif
                                </td>
                                ...
                                @php
                                    ...
                                    $value->total_exonerated =
                                        in_array($value->document_type_id, ['01', '03']) &&
