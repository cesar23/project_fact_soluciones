...
<div style="margin-top:20px; margin-bottom:20px;">
    <table>
        ...
        $clothes = \Modules\BusinessTurn\Models\BusinessTurn::isClothesShoes();
            ...
            <table class="">
                ...
                @foreach($records as $key => $value)
                    ...
                    <tr>
                        ...
                        @endif
                        @if($clothes)
                            <td class="celda" style="font-size: 10px;">
                                @foreach($itemKardex['sizes'] as $size)
                                    Talla: {{ $size['size'] }} - Cant.: {{ $size['qty'] }}
                                    <br>
                                @endforeach
                            </td>
                        @endif
