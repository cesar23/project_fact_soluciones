...
if($current_hostname) {
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::get('purchase-orders/print/{external_id}/{format?}', 'PurchaseOrderController@toPrint');
        ...
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('purchases')->group(function () {
                Route::get('tables-transfer', 'PurchaseController@tablesTransfer');
                Route::post('import-series', 'PurchaseController@importSeries');
                Route::get('record-transfer/{id}', 'PurchaseController@recordTransfer');
            });
            ...
            Route::prefix('purchase-orders')->group(function () {
                ...
                Route::get('series-by-type', 'PurchaseOrderController@getSeriesByType');
                Route::get('next-number', 'PurchaseOrderController@getNextNumber');
            ...
            Route::prefix('purchase-payments')->group(function () {
                ...
                Route::get('/fee/purchase_fee/{purchase_fee_id}', 'PurchasePaymentController@purchase_fee');
                Route::get('/fee/purchase_fee/records/{purchase_fee_id}', 'PurchasePaymentController@records_fee');
                Route::post('/fee', 'PurchasePaymentController@store_fee');
