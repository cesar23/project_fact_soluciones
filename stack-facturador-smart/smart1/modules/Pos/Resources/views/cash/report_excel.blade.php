...
<body>
    <div>
        <p align="center" class="title"><strong>Reporte Punto de Ventas</strong></p>
    </div>
    <div style="margin-top:20px; margin-bottom:20px;">
        <table>
            ...
            <tr>
                ...
                <td class="td-custom">
                    <p><strong>Fecha y hora apertura: </strong>{{ $data['cash_date_opening'] }}
                        {{ $data['cash_time_opening'] }}</p>
                </td>
            </tr>
            <tr>
                <td class="td-custom">
                ...
                @if (!$data['cash_state'])
                    <td class="td-custom">
                        <p><strong>Fecha y hora cierre: </strong>{{ $data['cash_date_closed'] }}
                            {{ $data['cash_time_closed'] }}</p>
                    </td>
                @endif
            </tr>
            <tr>
                    ...
                    <tbody>
                        @foreach ($data['all_documents'] as $key => $value)
                            ...
                            <br> {!! $value['usado'] !!}  <br> <strong>{{$value['tipo']}}</strong> --}}
                                ...
                                <td class="celda">
                                    {{ isset($value['total_payments']) ? $value['total_payments'] : '' }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
    ...
    @endif
    @php
        $all_credits = isset($data['document_credit']) ? $data['document_credit'] : [];
    @endphp

    @if (count($all_credits) > 0)
