            ...
            <div class=" ">
                ...
                <table class="">
                    ...
                    <th style="font-weight: bold;background: #0088cc;color: white;text-align: center;">N° Documento</th> --}}
                            ...
                            <th style="font-weight: bold;background: #0088cc;color: white;text-align: center;">Pagado
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <td class="celda">
                            {{ $value['customer_number'] }}
                                ...
                                <td class="celda">
                                    {{ isset($value['total_payments']) ? $value['total_payments'] : 0 }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                {{-- @php
                    ...
                    $document_credit = $data['document_credit'];

                @endphp

                @if (count($document_credit) > 0)

                    <p align="center" >Documentos dados a crédito</p>
                    <table>
                        <thead>
                            <tr>
                                <th style="font-weight: bold;background: #0088cc;color: white;text-align: center;">
                        ...
                        <tbody>
                            @foreach ($document_credit as $key => $value)
                                <tr>
                                    <td class="celda">
                                        {{ $loop->iteration }}
                                    </td>
