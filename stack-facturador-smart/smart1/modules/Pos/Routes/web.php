    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('cash')->group(function() {
                ...
                Route::get('report-cash/{cash}/{withBank?}', 'CashController@getDataToClosedCash');
                Route::get('closed-cash-info/{cash}', 'CashController@getClosedCashInfo');
                Route::get('report-a4/{cash}', 'CashController@reportA4');
                Route::get('report-a4-detail/{cash}', 'CashController@reportA4Detail');
                Route::get('report-a4-detail-2/{cash}', 'CashController@reportA4Detail2');
                Route::get('/get-data-special-info-cash/{cash_id}', 'CashController@getDataSpecialInfoCash');
                ...
                Route::get('simple-seller/report-a4/{cash}', 'CashController@reportSimpleSellerA4');
