...
use Modules\Seller\Traits\SellerSaleTrait;

class TipServiceProvider extends ServiceProvider
{

    use TipTrait,SellerSaleTrait;
    ...
    public function document()
    {
        ...
        Document::updated(function($document){
            ...
            $this->setSellerSale($document,true);
    ...
    public function sale_note()
    {
        ...
        SaleNote::updated(function($sale_note){
            ...
            $this->setSellerSale($sale_note,true);
