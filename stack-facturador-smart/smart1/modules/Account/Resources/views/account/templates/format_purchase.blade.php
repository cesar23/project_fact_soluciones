...
<table>
    ...
    --}}
    <tr>
        <td colspan="{{ $col_span }}" class="text-center font-weight">FORMATO 8.1 : "REGISTRO DE COMPRAS DEL PERIODO
            {{ $period }}"</td>
    </tr>
    <tr>
        <td colspan="2">
    ...
    @foreach ($records as $row)
        <tr>
            ...
            <td>{{ in_array($row['document_type_id'], ['01', '03']) && in_array($row['state_type_id'], ['09', '11']) ? 0 : $row['total_igv'] }}
            </td>
            <td></td>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td></td>
            <td>{{ in_array($row['document_type_id'], ['01', '03']) && in_array($row['state_type_id'], ['09', '11']) ? 0 : $row['total'] }}
            </td>
