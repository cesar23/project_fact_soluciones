...
Route::middleware(['check.permission', 'locked.tenant'])->prefix('ecommerce')->group(function() {
   // Route::get('/', 'EcommerceController@index');
    ...
    Route::post('updateUser', 'EcommerceController@updateUser');
    Route::get('recordUser/{id}', 'EcommerceController@recordUser');
    ...
    Route::get('store/users', 'EcommerceController@userIndex')->name('tenant_users_store');
    ...
    Route::post('configuration_columns', 'ConfigurationController@store_configuration_columns');
    Route::post('configuration_aditional', 'ConfigurationController@store_configuration_aditional');
    ...
    Route::post('configuration-digital-payments', 'ConfigurationController@store_configuration_digital_payments');
    Route::post('saveDataUser', 'EcommerceController@saveDataUser')->name('tenant_ecommerce_user_data');
    Route::get('configuration-digital-payments', 'ConfigurationController@get_configuration_digital_payments');   
    ...
    Route::prefix('woocommerce')->group(function() {
        Route::get('', 'WoocommerceController@index')->name('tenant.woocommerce');
        Route::get('configurations', 'WoocommerceController@configurations');
        Route::post('configurations', 'WoocommerceController@saveConfigurations');
        Route::get('woocommerce_config', 'WoocommerceController@syncronice_woocommerce');
        Route::get('check_woocommerce', 'WoocommerceController@has_woocommerce');
        Route::post('sync', 'WoocommerceController@sync');
        Route::post('sync_one', 'WoocommerceController@syncOne');
        Route::get('items', 'WoocommerceController@items');
    });

    Route::get('search-items', 'EcommerceController@searchItems');
