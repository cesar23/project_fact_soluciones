    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-md-6">
            <div class="product-single-details">
                ...
                @endphp
                <div class="price-box">
                    <!-- <span class="old-price">S/ {{ number_format( ($sale_unit_price * 1.2 ) , 2 )}}</span> -->
                    <span class="product-price">{{ $record->currency_type_symbol }} {{ number_format($sale_unit_price, 2 )}}</span>
                </div><!-- End .price-box -->
