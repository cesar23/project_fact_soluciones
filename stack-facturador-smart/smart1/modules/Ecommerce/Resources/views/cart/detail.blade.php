...
<div class="row" id="app">
    <div class="col-lg-8">
            ...
            <table class="table table-cart">
                ...
                <tbody>
                    <tr v-for="(row, index) in records" class="product-row">
                        ...
                        <td>
                            <div class="custom-quantity-field">
                                <button class="custom-quantity-btn minus" type="button" @click="decrementCantidad(row)">
                                    <i class="fas fa-minus"></i>
                                </button>
                                <input class="custom-quantity-input" 
                                       :data-product="row.id"
                                       v-model="row.cantidad"
                                       type="text" 
                                       readonly>
                                <button class="custom-quantity-btn plus" type="button" @click="incrementCantidad(row)">
        ...
        <!-- Inicio Opciones de entrega -->
        <div class="cart-table-container p-4">
                ...
                <div class="d-flex justify-content-around">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="deliveryOption" 
                               id="deliveryHome" value="delivery" v-model="delivery_type" checked>
                        <label class="form-check-label ml-2" for="deliveryHome">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="deliveryOption" 
                               id="pickupStore" value="pickup" v-model="delivery_type">
                        <label class="form-check-label ml-2" for="pickupStore">
            ...
            <div class="delivery-form mt-4">
                ...
                <form autocomplete="off" action="#">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nombre:</label>
                                <input v-model="form_contact.name" type="text" class="form-control" 
                                       placeholder="Nombre">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group" :class="{'text-danger': errors.telefono}">
                                ...
                                <input v-model="form_contact.telephone" type="text" class="form-control" 
                    ...
                    <div class="form-group">
                        <label>Correo:</label>
                        <input v-model="form_contact.email" type="email" class="form-control" 
                               placeholder="Correo">
                    </div>

                    <!-- Información de Entrega - Solo visible si es delivery -->
                    <div v-show="delivery_type === 'delivery'">
                        <h5 class="mb-3 mt-4">Información De Entrega</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" :class="{'text-danger': errors.address}">
                                    <label>Dirección:</label>
                                    <input v-model="form_contact.address" type="text" class="form-control" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input v-model="form_contact.reference" type="text" class="form-control" 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input v-model="form_contact.street" type="text" class="form-control" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>N° Casa:</label>
                                    <input v-model="form_contact.number" type="text" class="form-control" 
                                           placeholder="N° Casa">
                                </div>
                            </div>
                        </div>
        ...
        <!-- Fin Opciones de entrega -->

        <div class="cart-table-container p-5">
            <p>Historial</p>
            <table class="table table-cart">
                <thead>
                    <tr>
    ...
    <div class="col-lg-4">
        <div class="cart-summary">
            ...
            <div class="checkout-methods text-center">
                ...
                <template v-if="digital_payments.yape_number && digital_payments.yape_qr">
                    <button @click="showYape" class="btn btn-block btn-sm btn-payment-yape">
                        Pagar con YAPE
                    </button>
                    <div v-show="payment_yape.clicked" class="text-center mt-3 mb-3">
                        <p class="mb-2">Número Yape: @{{digital_payments.yape_number}}</p>
                        <div class="d-flex justify-content-center">
                            <img :src="digital_payments.yape_qr" alt="YAPE QR" class="img-fluid" style="max-width: 200px;">
                        </div>
                        <div class="input-group mt-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">S/</span>
                            </div>
                            <input readonly :value="summary.total" type="text" class="form-control text-center">
                            <button @click="paymentCash('yape')" class="btn btn-success">OK!</button>
                        </div>
                    </div>
                </template>

                <template v-if="digital_payments.plin_number && digital_payments.plin_qr">
                    <button @click="showPlin" class="btn btn-block btn-sm btn-primary">
                        Pagar con PLIN
                    </button>
                    <div v-show="payment_plin.clicked" class="text-center mt-3 mb-3">
                        <p class="mb-2">Número Plin: @{{digital_payments.plin_number}}</p>
                        <div class="d-flex justify-content-center">
                            <img :src="digital_payments.plin_qr" alt="PLIN QR" class="img-fluid" style="max-width: 200px;">
                        </div>
                        <div class="input-group mt-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">S/</span>
                            ...
                            <input readonly :value="summary.total" type="text" class="form-control text-center">
                            <button @click="paymentCash('plin')" class="btn btn-success">OK!</button>
                        </div>
                    </div>
                </template>
            
                <button @click="showCash" class="btn btn-block btn-sm btn-payment-cash">
                    Pagar con EFECTIVO
                </button>
                <div v-show="payment_cash.clicked" style="margin: 3%" class="form-group">
                    <div class="input-group mb-3">
                        ...
                        <input readonly :value="summary.total" type="text" class="form-control text-center">
                        <button @click="paymentCash('efectivo')" class="btn btn-success">OK!</button>
                    </div>
                </div>
...
<script type="text/javascript">
    var app_cart = new Vue({
        ...
        async mounted() {
          ...
          let {yape_qr, plin_qr, yape_number, plin_number,} = this.configuration
          yape_qr = yape_qr ? "/storage/uploads/ecommerce/" + yape_qr : null
          plin_qr = plin_qr ? "/storage/uploads/ecommerce/" + plin_qr : null
          this.digital_payments = {yape_number, plin_number, yape_qr, plin_qr}
        ...
        created() {
            ...
            if (array) {
                this.records = array.map(function (item) {
                    ...
                    obj.sub_total = (parseFloat(item.sale_unit_price) * parseFloat(item.quantity || 1)).toFixed(2)
        ...
        methods: {
            ...
            async getFormPaymentCash() {
                ...
                let street = this.form_contact.street;
                let number = this.form_contact.number;
                let reference = this.form_contact.reference;
                let address = this.form_contact.address;
                // let location_delivery = this.form_contact.location_delivery;
                return {
                    producto: 'Compras Ecommerce Facturador Smart',
                    precio: precio,
            ...
            async paymentCash(type) {
                ...
                let form = await this.getFormPaymentCash();
                form.reference_payment = type;
                form.is_delivery = this.delivery_type == 'delivery' ? true : false;

                if(form.is_delivery){
                    if(!form.address || !form.reference){
                        return this.showSwalMessage('Ocurrió un error!', 'Los campos dirección y referencia son obligatorios', 'error')
                    }
                }
                let response = await axios.post(url_finally, form, this.getHeaderConfig()).then(response => {
            ...
            calculateSummary() {
                ...
                console.log("la cantidad es", this.summary.total)
            ...
            decrementCantidad(row) {
                if (row.cantidad > 1) {
                    row.cantidad--;
                    this.updateCantidad(row);
                }
            },
            incrementCantidad(row) {
                row.cantidad++;
                this.updateCantidad(row);
            },
            updateCantidad(row) {
                let value = row.cantidad;
                
                if(row.currency_type_id === 'USD') {
                    row.sub_total = ((parseFloat(row.sale_unit_price) * value) * this.exchange_rate_sale).toFixed(2)
                } else {
                    row.sub_total = (parseFloat(row.sale_unit_price) * value).toFixed(2)
                }

                // Actualizar quantity en el item para el localStorage
            ...
            showYape() {
                this.payment_yape.clicked = !this.payment_yape.clicked;
                this.payment_plin.clicked = false;
                this.payment_cash.clicked = false;
            },
            showPlin() {
                this.payment_plin.clicked = !this.payment_plin.clicked;
                this.payment_yape.clicked = false;
                this.payment_cash.clicked = false;
            },
            showCash() {
                this.payment_cash.clicked = !this.payment_cash.clicked;
                this.payment_yape.clicked = false;
                this.payment_plin.clicked = false;
            }
        }
    ...
    //   console.log( 'errores22', app_cart.errors)
        ...
        if (precio > 0) {
            Culqi.settings({
                ...
                currency: 'PEN',
                description: 'Compras Ecommerce Facturador Smart',
                amount: precio
            });
            Culqi.open();
        }
