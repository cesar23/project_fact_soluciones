...
class ValidatePurchaseController extends Controller
{
    ...
    private function getDocumentsQuery($request)
    {
    ...
    public function processDocumentsForCompany(Request $request)
    {

        $configuration = Configuration::first();
        $company = Company::first();
        $documents = $this->getDocumentsQuery($request)->get();
