    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('documents')->group(function () {
                ...
                Route::get('prepayments/{type?}/{customer_id?}', 'DocumentController@prepayments');
                Route::get('search-items', 'DocumentController@searchItems');
                Route::get('search-items-favorite', 'DocumentController@searchItemsFavorite');
                Route::get('search-items-lite', 'DocumentController@searchItemsLite');
            ...
            Route::prefix('reports/validate-documents')->group(function () {
                ...
                //     Route::get('', 'ValidatePurchaseController@index')->name('tenant.validate_purchase.index')->middleware('tenant.internal.mode');
                //     Route::get('records', 'ValidatePurchaseController@records');
                //     Route::get('data_table', 'ValidatePurchaseController@data_table');
                //     Route::post('regularize', 'ValidatePurchaseController@regularize');
                // });
