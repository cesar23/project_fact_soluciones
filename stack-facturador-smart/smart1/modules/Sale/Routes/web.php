    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('payment-method-types')->group(function () {
                ...
                Route::post('/change-destination', 'PaymentMethodTypeController@changeDestination');
        ...
        Route::prefix('technical-services')->group(function () {
            ...
            Route::get('/change-state/{id}/{state_technical_service_id}', 'TechnicalServiceController@changeState');
            ...
            Route::post('/upload_image', 'TechnicalServiceController@uploadTempImage');
            Route::delete('/remove_image/{id}', 'TechnicalServiceController@removeImage');
        });
        Route::prefix('state-technical-services')->group(function () {

            Route::get('', 'TechnicalServiceStateController@index');
            Route::get('/records', 'TechnicalServiceStateController@records');
            Route::get('/record/{brand}', 'TechnicalServiceStateController@record');
            Route::post('', 'TechnicalServiceStateController@store');
            Route::delete('/{record}', 'TechnicalServiceStateController@destroy');
        });
