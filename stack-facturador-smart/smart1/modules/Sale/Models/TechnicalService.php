...
use Modules\Sale\Models\TechnicalServiceImage;
    ...
    class TechnicalService extends ModelTenant
    {
       ...
       // use SellerIdTrait;
        ...
        public function getCollectionData()
        {
            ...
            $total = $this->cost + $this->total;
            $quotation_id = null;
            $number_quotation = null;
            $quotation = TechnicalServiceQuotation::where('technical_service_id', $this->id)->first();
            if($quotation){
                $quotation_id = $quotation->quotation_id;
                $number_quotation = $quotation->quotation->number_full;
            }
            //docs asociados
            ...
            $images = $this->images->transform(function($row) {
                return [
                    'id' => $row->id,
            ...
            $data = array_merge($this->toArray(), [
                'preventive_maintenance' => (bool) $this->preventive_maintenance,
                'corrective_maintenance' => (bool) $this->corrective_maintenance,
                'ironing_and_painting' => (bool) $this->ironing_and_painting,
                'equipments' => (bool) $this->equipments,
        ...
        {
            return $this->hasMany(TechnicalServiceImage::class);
        }
