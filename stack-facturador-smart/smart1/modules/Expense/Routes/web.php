    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('expenses')->group(function () {
                ...
                Route::get('duplicate/{id}', 'ExpenseController@duplicate');
                Route::get('report/excel', 'ExpenseController@excel');
                Route::get('report/pdf', 'ExpenseController@pdf');
                Route::get('print/{external_id}/{format?}', 'ExpenseController@toPrint');
                Route::post('evidencias/{expense}', 'ExpenseController@processEvidenciasExpense');
                Route::post('upload-evidencia', 'ExpenseController@uploadpevidencia');
            });
            /**
             * Creditos bancarios
             * bank_loan/
