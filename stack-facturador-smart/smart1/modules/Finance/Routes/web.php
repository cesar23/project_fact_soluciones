...
if($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        Route::get('/finances/payment-file/download-file/{filename}/{type}', 'PaymentFileController@download');
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function() {
            ...
            Route::prefix('finances')->group(function () {
                ...
                Route::get('global-payments/excel-manual', 'GlobalPaymentController@excelManual');
                ...
                Route::get('due-to-pay', 'ToPayController@dueToPay');
                /**
                 * finances/balance
                ...
                Route::prefix('unpaid')->group(function () {
                    ...
                    Route::get('/pdf_s_especial', 'UnpaidController@pdf_s_especial');
                    Route::get('/eecc-customer', 'UnpaidController@eeccCustomer');
                ...
                Route::post('payment-file-record/upload', 'PaymentFileController@uploadAttachedRecord');
                ...
                Route::prefix('to-pay')->group(function () {
                    ...
                    Route::get('/pdf_s', 'ToPayController@pdf_s');
                    Route::get('/pdf_s_especial', 'ToPayController@pdf_s_especial');
                    Route::get('/eecc-supplier', 'ToPayController@eeccSupplier');
                });
