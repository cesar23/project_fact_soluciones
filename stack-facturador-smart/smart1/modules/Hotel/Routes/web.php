		...
		Route::middleware(['auth', 'redirect.module', 'locked.tenant'])
			...
			->group(function () {
				Route::prefix('reservations')->group(function () {
					Route::get('', 'HotelReservationController@index')->name('tenant.hotels.reservations.index');
					Route::get('tables', 'HotelReservationController@tables');
					Route::post('', 'HotelReservationController@store');
					Route::get('records', 'HotelReservationController@records');
					Route::get('pdf/{id}', 'HotelReservationController@pdf');
					Route::get('{id}', 'HotelReservationController@record');
					Route::delete('{id}', 'HotelReservationController@delete');
					Route::get('records-by-room/{roomId}', 'HotelReservationController@getReservationsByRoom');
					// Nuevas rutas para el calendario
					Route::get('calendar/month/{year}/{month}', 'HotelReservationController@getMonthReservations');
					Route::get('calendar/week/{year}/{month}/{day}', 'HotelReservationController@getWeekReservationsLite');
					Route::get('calendar/day/{year}/{month}/{day}', 'HotelReservationController@getDayReservations');
				});
				// Tarifas
				...
				Route::get('rooms/search', 'HotelRoomController@searchRooms');
				...
				Route::get('rooms/{id}/status', 'HotelRoomController@verifyRoomStatus');
                ...
                Route::prefix('reception')->group(function () {
                    ...
                    Route::get('/{id}/payments', 'HotelRentController@payments');
                    Route::post('/{id}/rent/finalized', 'HotelRentController@finalizeRent');
                    Route::post('/{id}/rent/finalized-without-invoice', 'HotelRentController@finalizeRentWithoutInvoice');
                    Route::get('/{id}/rent/items', 'HotelRentController@rentItems');
					Route::post('/{id}/rent/document-emitted', 'HotelRentController@documentEmitted');
