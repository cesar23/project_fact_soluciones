...
print_message "$MAGENTA" "═══════════════════════════════════════════════════════════════════"
echo ""
print_message "$GREEN" "docker exec -it fpm1 bash -c \""
print_message "$GREEN" "  composer self-update && \\"
print_message "$GREEN" "  composer install && \\"
print_message "$GREEN" "  php artisan migrate:refresh --seed && \\"
print_message "$GREEN" "  php artisan key:generate && \\"
print_message "$GREEN" "  php artisan storage:link\""
echo ""
print_message "$MAGENTA" "═══════════════════════════════════════════════════════════════════"
echo ""
